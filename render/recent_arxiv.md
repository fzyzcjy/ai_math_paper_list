...
1. **Ensembling Large Language Models with Process Reward-Guided Tree Search for Better Complex Reasoning** [[pdf]](http://arxiv.org/abs/2412.15797) `2024-12-20` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work presents Language model Ensemble with Monte Carlo Tree Search (LE-MCTS), a novel framework for process-level ensembling of language models that outperforms both single language model decoding algorithms and language model ensemble methods.
     </details>
...
2. **Formal Mathematical Reasoning: A New Frontier in AI** [[pdf]](http://arxiv.org/abs/2412.16075) `2024-12-20` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This position paper advocate for formal mathematical reasoning and argues that it is indispensable for advancing AI4Math to the next level and calls on the research community to come together to drive transformative advancements in this field.
     </details>
...
3. **Offline Reinforcement Learning for LLM Multi-Step Reasoning** [[pdf]](http://arxiv.org/abs/2412.16145) `2024-12-20` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          O (Offline Reasoning Optimization), an offline RL method for enhancing LLM multi-step reasoning, jointly learns a policy model and value function by optimizing the soft Bellman Equation and surpasses existing offline learning methods on multi-step reasoning benchmarks.
     </details>
...
4. **What Are Step-Level Reward Models Rewarding? Counterintuitive Findings from MCTS-Boosted Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2412.15904) `2024-12-20` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The findings reveal that the removal of natural language descriptions of thought processes has minimal impact on the efficacy of SRMs, and it is demonstrated that SRMs are adept at assessing the complex logical coherence present in mathematical language while having difficulty in natural language.
     </details>
...
5. **AceMath: Advancing Frontier Math Reasoning with Post-Training and Reward Modeling** [[pdf]](http://arxiv.org/abs/2412.15084) `2024-12-19` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This paper introduces AceMath, a suite of frontier math models that excel in solving complex math problems, along with highly effective reward models capable of evaluating generated solutions and reliably identifying the correct ones, and presents a systematic approach to build math reward models.
     </details>
...
6. **Confidence in the Reasoning of Large Language Models** [[pdf]](http://arxiv.org/abs/2412.15296) `2024-12-19` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The material effects of prompting on qualitative confidence and the strong tendency for overconfidence indicate that current LLMs do not have any internally coherent sense of confidence.
     </details>
...
7. **Data for Mathematical Copilots: Better Ways of Presenting Proofs for Machine Learning** [[pdf]](http://arxiv.org/abs/2412.15184) `2024-12-19` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work systematically explores limitations of the suite of datasets commonly used to train and evaluate the mathematical capabilities of AI-based mathematical copilots and advocates for mathematical dataset developers to consider the concept of "motivated proof", introduced by G. P\'olya in 1949, which can serve as a blueprint for datasets that offer a better proof learning signal.
     </details>
...
8. **Eliciting Causal Abilities in Large Language Models for Reasoning Tasks** [[pdf]](http://arxiv.org/abs/2412.15314) `2024-12-19` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The Self-Causal Instruction Enhancement (SCIE) method is introduced, which enables LLMs to generate high-quality, low-quantity observational data, then estimates the causal effect based on these data, and ultimately generates instructions with the optimized causal effect.
     </details>
...
9. **Progressive Multimodal Reasoning via Active Retrieval** [[pdf]](http://arxiv.org/abs/2412.14835) `2024-12-19` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The AR-MCTS framework is proposed, a universal framework designed to progressively improve the reasoning capabilities of MLLMs through Active Retrieval and Monte Carlo Tree Search, and can optimize sampling diversity and accuracy, yielding reliable multimodal reasoning.
     </details>
...
10. **MetaRuleGPT: Recursive Numerical Reasoning of Language Models Trained with Simple Rules** [[pdf]](http://arxiv.org/abs/2412.13536) `2024-12-18` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          These findings prove the potential of rule learning to enhance the numerical reasoning abilities of language models and introduce MetaRuleGPT, a novel Transformer-based architecture that performs precise numerical calculations and complex logical operations by learning and combining different rules.
     </details>
...
11. **Scaling of Search and Learning: A Roadmap to Reproduce o1 from Reinforcement Learning Perspective** [[pdf]](http://arxiv.org/abs/2412.14135) `2024-12-18` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The roadmap to achieving o1 is analyzed from the perspective of reinforcement learning, focusing on four key components: policy initialization, reward design, search, and learning, which underscore how learning and search drive o1's advancement.
     </details>
...
12. **Are Your LLMs Capable of Stable Reasoning?** [[pdf]](http://arxiv.org/abs/2412.13147) `2024-12-17` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work introduces G-Pass@k, a novel evaluation metric that provides a continuous assessment of model performance across multiple sampling attempts, quantifying both the model's peak performance potential and its stability and presents LiveMathBench, a dynamic benchmark comprising challenging, contemporary mathematical problems designed to minimize data leakage risks during evaluation.
     </details>
...
13. **Compressed Chain of Thought: Efficient Reasoning Through Dense Representations** [[pdf]](http://arxiv.org/abs/2412.13171) `2024-12-17` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          Compressed Chain-of-Thought (CCoT) is proposed, a framework to generate contentful and continuous contemplation tokens of variable sequence length that enables additional reasoning over dense contentful representations to achieve corresponding improvements in accuracy.
     </details>
...
14. **MultiLingPoT: Enhancing Mathematical Reasoning with Multilingual Program Fine-tuning** [[pdf]](http://arxiv.org/abs/2412.12609) `2024-12-17` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This paper proposes an multilingual program reasoning method, MultiLingPoT, which allows the model to answer questions using multiple programming languages by fine-tuning on multilingual data and uses prior and posterior hybrid methods to help the model select the most suitable language for each problem.
     </details>
...
15. **A Survey of Mathematical Reasoning in the Era of Multimodal Large Language Model: Benchmark, Method & Challenges** [[pdf]](http://arxiv.org/abs/2412.11936) `2024-12-16` (0 cite) (0 AI4Math cite) 
...
16. **C3oT: Generating Shorter Chain-of-Thought without Compromising Effectiveness** [[pdf]](http://arxiv.org/abs/2412.11664) `2024-12-16` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          A conditioned training method to train LLMs with both longer CoT and shorter CoT simultaneously to learn the corresponding relationships between them, and a conditioned inference method to gain the reasoning ability learned from longer CoT by generating shorter CoT are presented.
     </details>
...
17. **Can Language Models Rival Mathematics Students? Evaluating Mathematical Reasoning through Textual Manipulation and Human Experiments** [[pdf]](http://arxiv.org/abs/2412.11908) `2024-12-16` (0 cite) (0 AI4Math cite) 
...
18. **CoinMath: Harnessing the Power of Coding Instruction for Math LLMs** [[pdf]](http://arxiv.org/abs/2412.11699) `2024-12-16` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          Findings reveal that code-based rationales with concise comments, descriptive naming, and hardcoded solutions are beneficial, while improvements from general-domain coding instructions and textual rationales are relatively minor.
     </details>
...
19. **Stepwise Reasoning Error Disruption Attack of LLMs** [[pdf]](http://arxiv.org/abs/2412.11934) `2024-12-16` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The Stepwise rEasoning Error Disruption (SEED) attack is proposed, which subtly injects errors into prior reasoning steps to mislead the model into producing incorrect subsequent reasoning and final answers.
     </details>
...
20. **Proposing and solving olympiad geometry with guided tree search** [[pdf]](http://arxiv.org/abs/2412.10673) `2024-12-14` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          TongGeometry, a Euclidean geometry system supporting tree-search-based guided problem proposing and solving, establishes the most extensive repository of geometry theorems to date, and surpasses the existing state-of-the-art across a broader spectrum of olympiad-level problems.
     </details>
...
21. **Enhancing the Reasoning Capabilities of Small Language Models via Solution Guidance Fine-Tuning** [[pdf]](http://arxiv.org/abs/2412.09906) `2024-12-13` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          Experimental results demonstrate that the new reasoning strategy Solution Guidance (SG) and a plug-and-play training paradigm Solution-Guidance Fine-Tuning (SGFT) significantly improves the performance of SLMs on various reasoning tasks, enhancing both their practicality and efficiency within resource-constrained environments.
     </details>
...
22. **A Graph-Based Synthetic Data Pipeline for Scaling High-Quality Reasoning Instructions** [[pdf]](http://arxiv.org/abs/2412.08864) `2024-12-12` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          The Graph-based Synthetic Data Pipeline (GSDP), an economical and scalable framework for high-quality reasoning data synthesis, is proposed, Inspired by knowledge graphs, and extracted knowledge points from seed data and constructed a knowledge point relationships graph to explore their interconnections.
     </details>
...
23. **Dipper: Diversity in Prompts for Producing Large Language Model Ensembles in Reasoning tasks** [[pdf]](http://arxiv.org/abs/2412.15238) `2024-12-12` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work proposes a novel, training-free LLM ensemble framework where a single LLM model is fed an optimized, diverse set of prompts in parallel, effectively producing an ensemble at inference time to achieve performance improvement in reasoning tasks.
     </details>
...
24. **Forest-of-Thought: Scaling Test-Time Compute for Enhancing LLM Reasoning** [[pdf]](http://arxiv.org/abs/2412.09078) `2024-12-12` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          Experimental results demonstrate that the FoT framework, combined with consensus-guided decision making strategies, significantly enhances the reasoning capabilities of LLMs, enabling them to solve complex tasks with greater precision and efficiency.
     </details>
...
25. **GReaTer: Gradients over Reasoning Makes Smaller Language Models Strong Prompt Optimizers** [[pdf]](http://arxiv.org/abs/2412.09722) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
26. **Imitate, Explore, and Self-Improve: A Reproduction Report on Slow-thinking Reasoning Systems** [[pdf]](http://arxiv.org/abs/2412.09413) `2024-12-12` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          An ``imitate, explore, and self-improve'' framework, denoted as \textbf{STILL-2}, is introduced as the primary technical approach to train the reasoning model, enabling it to invoke a slow-thinking mode and achieves competitive performance compared to industry-level reasoning systems on these benchmarks.
     </details>
...
27. **Efficient Rectification of Neuro-Symbolic Reasoning Inconsistencies by Abductive Reflection** [[pdf]](http://arxiv.org/abs/2412.08457) `2024-12-11` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work proposes to improve NeSy systems by introducing Abductive Reflection (ABL-Refl) based on the Abductive Learning (ABL) framework, and shows that ABL-Refl outperforms state-of-the-art NeSy methods, achieving excellent accuracy with fewer training resources and enhanced efficiency.
     </details>
...
28. **HARP: A challenging human-annotated math reasoning benchmark** [[pdf]](http://arxiv.org/abs/2412.08819) `2024-12-11` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work introduces HARP, Human Annotated Reasoning Problems (for Math), and reports evaluations for many frontier models and shares some interesting analyses, such as demonstrating that frontier models across families intrinsically scale their inference-time compute for more difficult problems.
     </details>
...
29. **Learning to Reason via Self-Iterative Process Feedback for Small Language Models** [[pdf]](http://arxiv.org/abs/2412.08393) `2024-12-11` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This study enables SLMs to learn to reason from self-iterative feedback by combining odds ratio preference optimization (ORPO) and supervised fine-tuning (SFT) with process supervision for rewards in preference alignment by sampling-based inference simulation and process reward models.
     </details>
...
30. **SmolTulu: Higher Learning Rate to Batch Size Ratios Can Lead to Better Reasoning in SLMs** [[pdf]](http://arxiv.org/abs/2412.08347) `2024-12-11` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          It is demonstrated that careful adaptation of optimization dynamics can help bridge the capability gap between small and large language models, demonstrating that careful adaptation of optimization dynamics can help bridge the capability gap between small and large language models.
     </details>
...
31. **TinyThinker: Distilling Reasoning through Coarse-to-Fine Knowledge Internalization with Self-Reflection** [[pdf]](http://arxiv.org/abs/2412.08024) `2024-12-11` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          TinyThinker, a framework introducing a three-stage process that incrementally guides the student model through the reasoning process, progressively refining knowledge from coarse to fine granularity, is proposed.
     </details>
...
32. **What Makes In-context Learning Effective for Mathematical Reasoning: A Theoretical Analysis** [[pdf]](http://arxiv.org/abs/2412.12157) `2024-12-11` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          It is proved that the reasoning efficacy can be bounded by a LLM-oriented semantic similarity and an inference stability of demonstrations, which is general for both one-shot and few-shot scenarios and proposed LMS3, a straightforward, generalizable, and low-complexity demonstration selection method.
     </details>
...
33. **ProcessBench: Identifying Process Errors in Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2412.06559) `2024-12-10` (1 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This paper introduces ProcessBench for measuring the ability to identify erroneous steps in mathematical reasoning, and draws two main observations: existing PRMs typically fail to generalize to more challenging math problems beyond GSM8K and MATH, and the best open-source model has demonstrated the critique capability competitive with the proprietary model GPT-4o.
     </details>
...
34. **Algorithmic Phase Transitions in Language Models: A Mechanistic Case Study of Arithmetic** [[pdf]](http://arxiv.org/abs/2412.07386) `2024-12-10` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          It is suggested that algorithmic instability may be a contributing factor to language models' poor zero-shot performance across certain logical reasoning tasks, as they struggle to abstract different problem-solving strategies and smoothly transition between them.
     </details>
...
35. **Dynamic Ensemble Reasoning for LLM Experts** [[pdf]](http://arxiv.org/abs/2412.07448) `2024-12-10` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This paper proposes a Dynamic Ensemble Reasoning paradigm, called DER to integrate the strengths of multiple LLM experts conditioned on dynamic inputs, and develops a Knowledge Transfer Prompt (KTP) that enables the subsequent LLM candidates to transfer complementary knowledge effectively.
     </details>
...
36. **Training Large Language Models to Reason in a Continuous Latent Space** [[pdf]](http://arxiv.org/abs/2412.06769) `2024-12-09` (1 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work introduces a new paradigm Coconut (Chain of Continuous Thought), which utilizes the last hidden state of the LLM as a representation of the reasoning state (termed"continuous thought") and feeds it back to the LLM as the subsequent input embedding directly in the continuous space.
     </details>
...
37. **Can OpenAI o1 outperform humans in higher-order cognitive thinking?** [[pdf]](http://arxiv.org/abs/2412.05753) `2024-12-07` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          While o1-preview excelled in structured tasks, it showed limitations in problem-solving and adaptive reasoning, demonstrating the potential of AI to complement education in structured assessments but highlight the need for ethical oversight and refinement for broader applications.
     </details>
...
38. **MAmmoTH-VL: Eliciting Multimodal Reasoning with Instruction Tuning at Scale** [[pdf]](http://arxiv.org/abs/2412.05237) `2024-12-06` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This work introduces a scalable and cost-effective method to construct a large-scale multimodal instruction-tuning dataset with rich intermediate rationales designed to elicit CoT reasoning, and creates a dataset containing 12M instruction-response pairs to cover diverse, reasoning-intensive tasks with detailed and faithful rationales.
     </details>
...
39. **ARC Prize 2024: Technical Report** [[pdf]](http://arxiv.org/abs/2412.04604) `2024-12-05` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          Top approaches are surveyed, new open-source implementations are reviewed, new open-source implementations are reviewed, the limitations of the ARC-AGI-1 dataset are discussed, and key insights gained from the competition are shared.
     </details>
...
40. **Enhancing Mathematical Reasoning in LLMs with Background Operators** [[pdf]](http://arxiv.org/abs/2412.04110) `2024-12-05` (0 cite) (0 AI4Math cite) 
...
41. **Evolutionary Pre-Prompt Optimization for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2412.04291) `2024-12-05` (0 cite) (0 AI4Math cite) 
...
42. **Guidance is All You Need: Temperature-Guided Reasoning in Large Language Models** [[pdf]](http://arxiv.org/abs/2412.06822) `2024-12-05` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          Quasar-1 is presented, a novel architecture that introduces temperature-guided reasoning to large language models through the Token Temperature Mechanism and Guided Sequence of Thought, which proves that the temperature-guided attention mechanism converges to optimal reasoning paths with exponential guarantees.
     </details>
...
43. **MTMT: Consolidating Multiple Thinking Modes to Form a Thought Tree for Strengthening LLM** [[pdf]](http://arxiv.org/abs/2412.03987) `2024-12-05` (0 cite) (0 AI4Math cite) 
...
44. **REL: Working out is all you need** [[pdf]](http://arxiv.org/abs/2412.04645) `2024-12-05` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This paper demonstrates that by constructing a specialized dataset focused on explicit problem-solving workflows ("worked solutions"), it can elicit substantially improved planning capabilities from existing models, and proposes the Reasoning Enhancement Loop (REL), a method for generating synthetic worked solutions.
     </details>
...
45. **Artificial Expert Intelligence through PAC-reasoning** [[pdf]](http://arxiv.org/abs/2412.02441) `2024-12-03` (0 cite) (0 AI4Math cite) 
...
46. **Mind the Gap: Examining the Self-Improvement Capabilities of Large Language Models** [[pdf]](http://arxiv.org/abs/2412.02674) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
47. **Free Process Rewards without Process Labels** [[pdf]](http://arxiv.org/abs/2412.01981) `2024-12-02` (0 cite) (0 AI4Math cite) 
...
48. **MALT: Improving Reasoning with Multi-Agent LLM Training** [[pdf]](http://arxiv.org/abs/2412.01928) `2024-12-02` (0 cite) (0 AI4Math cite) 
...
49. **Think-to-Talk or Talk-to-Think? When LLMs Come Up with an Answer in Multi-Step Reasoning** [[pdf]](http://arxiv.org/abs/2412.01113) `2024-12-02` (0 cite) (0 AI4Math cite) 
...
50. **Improving Multimodal LLMs Ability In Geometry Problem Solving, Reasoning, And Multistep Scoring** [[pdf]](http://arxiv.org/abs/2412.00846) `2024-12-01` (0 cite) (0 AI4Math cite) 
...
51. **Reverse Thinking Makes LLMs Stronger Reasoners** [[pdf]](http://arxiv.org/abs/2411.19865) `2024-11-29` (0 cite) (0 AI4Math cite) 
...
52. **A Lean Dataset for International Math Olympiad: Small Steps towards Writing Math Proofs for Hard Problems** [[pdf]](http://arxiv.org/abs/2411.18872) `2024-11-28` (0 cite) (0 AI4Math cite) 
...
53. **MATATA: a weak-supervised MAthematical Tool-Assisted reasoning for Tabular Applications** [[pdf]](http://arxiv.org/abs/2411.18915) `2024-11-28` (0 cite) (0 AI4Math cite) 
...
54. **Mars-PO: Multi-Agent Reasoning System Preference Optimization** [[pdf]](http://arxiv.org/abs/2411.19039) `2024-11-28` (0 cite) (0 AI4Math cite) 
...
55. **Beyond Examples: High-level Automated Reasoning Paradigm in In-Context Learning via MCTS** [[pdf]](http://arxiv.org/abs/2411.18478) `2024-11-27` (0 cite) (0 AI4Math cite) 
...
56. **Training and Evaluating Language Models with Template-based Data Generation** [[pdf]](http://arxiv.org/abs/2411.18104) `2024-11-27` (0 cite) (0 AI4Math cite) 
...
57. **Enhancing LLM Reasoning via Critique Models with Test-Time and Training-Time Supervision** [[pdf]](http://arxiv.org/abs/2411.16579) `2024-11-25` (0 cite) (0 AI4Math cite) 
...
58. **Learning by Analogy: Enhancing Few-Shot Prompting for Math Word Problem Solving with Computational Graph-Based Retrieval** [[pdf]](http://arxiv.org/abs/2411.16454) `2024-11-25` (0 cite) (0 AI4Math cite) 
...
59. **O1 Replication Journey -- Part 2: Surpassing O1-preview through Simple Distillation, Big Progress or Bitter Lesson?** [[pdf]](http://arxiv.org/abs/2411.16489) `2024-11-25` (0 cite) (0 AI4Math cite) 
...
60. **Unraveling Arithmetic in Large Language Models: The Role of Algebraic Structures** [[pdf]](http://arxiv.org/abs/2411.16260) `2024-11-25` (0 cite) (0 AI4Math cite) 
...
61. **Evolution of Thought: Diverse and High-Quality Reasoning via Multi-Objective Optimization** [[pdf]](http://arxiv.org/abs/2412.07779) `2024-11-24` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This study introduces the Non-dominated Sorting Genetic Algorithm II for multi-objective optimization, utilizing crossover and mutation operators to promote greater diversity in reasoning solutions and proposes a Condensation-Aggregation mechanism to cluster and eliminate redundant paths, facilitate improved information sharing among parent nodes, and ultimately enhance both the efficiency and quality of the reasoning process.
     </details>
...
62. **MC-NEST -- Enhancing Mathematical Reasoning in Large Language Models with a Monte Carlo Nash Equilibrium Self-Refine Tree** [[pdf]](http://arxiv.org/abs/2411.15645) `2024-11-23` (0 cite) (0 AI4Math cite) 
...
63. **Improving Mathematical Reasoning Capabilities of Small Language Models via Feedback-Driven Distillation** [[pdf]](http://arxiv.org/abs/2411.14698) `2024-11-22` (0 cite) (0 AI4Math cite) 
...
64. **Marco-o1: Towards Open Reasoning Models for Open-Ended Solutions** [[pdf]](http://arxiv.org/abs/2411.14405) `2024-11-21` (0 cite) (0 AI4Math cite) 
...
65. **Patience Is The Key to Large Language Model Reasoning** [[pdf]](http://arxiv.org/abs/2411.13082) `2024-11-20` (0 cite) (0 AI4Math cite) 
...
66. **Enhancing Reasoning Capabilities of LLMs via Principled Synthetic Logic Corpus** [[pdf]](http://arxiv.org/abs/2411.12498) `2024-11-19` (0 cite) (0 AI4Math cite) 
...
67. **AtomThink: A Slow Thinking Framework for Multimodal Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2411.11930) `2024-11-18` (0 cite) (0 AI4Math cite) 
...
68. **Newclid: A User-Friendly Replacement for AlphaGeometry** [[pdf]](http://arxiv.org/abs/2411.11938) `2024-11-18` (0 cite) (0 AI4Math cite) 
...
69. **PSPO*: An Effective Process-supervised Policy Optimization for Reasoning Alignment** [[pdf]](http://arxiv.org/abs/2411.11681) `2024-11-18` (0 cite) (0 AI4Math cite) 
...
70. **Rethinking Thinking Tokens: Understanding Why They Underperform in Practice** [[pdf]](http://arxiv.org/abs/2411.11371) `2024-11-18` (0 cite) (0 AI4Math cite) 
...
71. **Technical Report: Enhancing LLM Reasoning with Reward-guided Tree Search** [[pdf]](http://arxiv.org/abs/2411.11694) `2024-11-18` (0 cite) (0 AI4Math cite) 
...
72. **Understanding Chain-of-Thought in LLMs through Information Theory** [[pdf]](http://arxiv.org/abs/2411.11984) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
73. **Enhancing the Reasoning Ability of Multimodal Large Language Models via Mixed Preference Optimization** [[pdf]](http://arxiv.org/abs/2411.10442) `2024-11-15` (0 cite) (0 AI4Math cite) 
...
74. **UTMath: Math Evaluation with Unit Test via Reasoning-to-Coding Thoughts** [[pdf]](http://arxiv.org/abs/2411.07240) `2024-11-11` (0 cite) (0 AI4Math cite) 
...
75. **OpenAI-o1 AB Testing: Does the o1 model really do good reasoning in math problem solving?** [[pdf]](http://arxiv.org/abs/2411.06198) `2024-11-09` (0 cite) (0 AI4Math cite) 
...
76. **Gap-Filling Prompting Enhances Code-Assisted Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2411.05407) `2024-11-08` (0 cite) (0 AI4Math cite) 
...
77. **Mathematical Formalized Problem Solving and Theorem Proving in Different Fields in Lean 4** [[pdf]](http://arxiv.org/abs/2409.05977) `2024-11-08` (0 cite) (0 AI4Math cite) 
...
78. **Quantifying artificial intelligence through algebraic generalization** [[pdf]](http://arxiv.org/abs/2411.05943) `2024-11-08` (0 cite) (0 AI4Math cite) 
...
79. **Qwen2.5-32B: Leveraging Self-Consistent Tool-Integrated Reasoning for Bengali Mathematical Olympiad Problem Solving** [[pdf]](http://arxiv.org/abs/2411.05934) `2024-11-08` (0 cite) (0 AI4Math cite) 
...
80. **VISTA: Visual Integrated System for Tailored Automation in Math Problem Generation Using LLM** [[pdf]](http://arxiv.org/abs/2411.05423) `2024-11-08` (0 cite) (0 AI4Math cite) 
...
81. **Benchmarking Large Language Models with Integer Sequence Generation Tasks** [[pdf]](http://arxiv.org/abs/2411.04372) `2024-11-07` (0 cite) (0 AI4Math cite) 
...
82. **FrontierMath: A Benchmark for Evaluating Advanced Mathematical Reasoning in AI** [[pdf]](http://arxiv.org/abs/2411.04872) `2024-11-07` (0 cite) (0 AI4Math cite) 
...
83. **Kwai-STaR: Transform LLMs into State-Transition Reasoners** [[pdf]](http://arxiv.org/abs/2411.04799) `2024-11-07` (0 cite) (0 AI4Math cite) 
...
84. **EXPLORA: Efficient Exemplar Subset Selection for Complex Reasoning** [[pdf]](http://arxiv.org/abs/2411.03877) `2024-11-06` (0 cite) (0 AI4Math cite) 
...
85. **Language Models are Hidden Reasoners: Unlocking Latent Reasoning Capabilities via Self-Rewarding** [[pdf]](http://arxiv.org/abs/2411.04282) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
86. **Self-Consistency Preference Optimization** [[pdf]](http://arxiv.org/abs/2411.04109) `2024-11-06` (0 cite) (0 AI4Math cite) 
...
87. **Towards Interpreting Language Models: A Case Study in Multi-Hop Reasoning** [[pdf]](http://arxiv.org/abs/2411.05037) `2024-11-06` (0 cite) (0 AI4Math cite) 
...
88. **Automatic Generation of Question Hints for Mathematics Problems using Large Language Models in Educational Technology** [[pdf]](http://arxiv.org/abs/2411.03495) `2024-11-05` (0 cite) (0 AI4Math cite) 
...
89. **Formal Theorem Proving by Rewarding LLMs to Decompose Proofs Hierarchically** [[pdf]](http://arxiv.org/abs/2411.01829) `NeurIPS 2024 Workshop MATH-AI` `Isabelle` (0 cite) (0 AI4Math cite) 
...
90. **Regress, Don't Guess -- A Regression-like Loss on Number Tokens for Language Models** [[pdf]](http://arxiv.org/abs/2411.02083) `2024-11-04` (0 cite) (0 AI4Math cite) 
...
91. **Learning Rules Explaining Interactive Theorem Proving Tactic Prediction** [[pdf]](http://arxiv.org/abs/2411.01188) `2024-11-02` (0 cite) (0 AI4Math cite) 
...
92. **PatternBoost: Constructions in Mathematics with a Little Help from AI** [[pdf]](http://arxiv.org/abs/2411.00566) `2024-11-01` (0 cite) (0 AI4Math cite) 
...
93. **Can Language Models Perform Robust Reasoning in Chain-of-thought Prompting with Noisy Rationales?** [[pdf]](http://arxiv.org/abs/2410.23856) `2024-10-31` (0 cite) (0 AI4Math cite) 
...
94. **What Happened in LLMs Layers when Trained for Fast vs. Slow Thinking: A Gradient Perspective** [[pdf]](http://arxiv.org/abs/2410.23743) `2024-10-31` (0 cite) (0 AI4Math cite) 
...
95. **VisAidMath: Benchmarking Visual-Aided Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.22995) `2024-10-30` (0 cite) (0 AI4Math cite) 
...
96. **DynaMath: A Dynamic Visual Benchmark for Evaluating Mathematical Reasoning Robustness of Vision Language Models** [[pdf]](http://arxiv.org/abs/2411.00836) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
97. **Let's Be Self-generated via Step by Step: A Curriculum Learning Approach to Automated Reasoning with Large Language Models** [[pdf]](http://arxiv.org/abs/2410.21728) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
98. **Arithmetic Without Algorithms: Language Models Solve Math With a Bag of Heuristics** [[pdf]](http://arxiv.org/abs/2410.21272) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
99. **Geo-LLaVA: A Large Multi-Modal Model for Solving Geometry Math Problems with Meta In-Context Learning** [[pdf]](http://arxiv.org/abs/2412.10455) `2024-10-28` (0 cite) (0 AI4Math cite) 


     <details>
          <summary>SemanticsScholar tldr</summary>
          This research collects a geometry question-answer dataset by sourcing geometric data from Chinese high school education websites, referred to as GeoMath, and proposes a Large Multi-modal Model (LMM) framework named Geo-LLaVA, which incorporates retrieval augmentation with supervised fine-tuning (SFT) in the training stage, and employs in-context learning (ICL) during inference to improve performance.
     </details>
...
100. **Guiding Through Complexity: What Makes Good Supervision for Hard Reasoning Tasks?** [[pdf]](http://arxiv.org/abs/2410.20533) `2024-10-27` (0 cite) (0 AI4Math cite) 
...
101. **GFlowNet Fine-tuning for Diverse Correct Solutions in Mathematical Reasoning Tasks** [[pdf]](http://arxiv.org/abs/2410.20147) `2024-10-26` (0 cite) (0 AI4Math cite) 
...
102. **Reasoning or a Semblance of it? A Diagnostic Study of Transitive Reasoning in LLMs** [[pdf]](http://arxiv.org/abs/2410.20200) `2024-10-26` (0 cite) (0 AI4Math cite) 
...
103. **As Simple as Fine-tuning: LLM Alignment via Bidirectional Negative Feedback Loss** [[pdf]](http://arxiv.org/abs/2410.04834) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
104. **Can Stories Help LLMs Reason? Curating Information Space Through Narrative** [[pdf]](http://arxiv.org/abs/2410.19221) `2024-10-25` (0 cite) (0 AI4Math cite) 
...
105. **Cooperative Strategic Planning Enhances Reasoning Capabilities in Large Language Models** [[pdf]](http://arxiv.org/abs/2410.20007) `2024-10-25` (0 cite) (0 AI4Math cite) 
...
106. **Assessing the Creativity of LLMs in Proposing Novel Solutions to Mathematical Problems** [[pdf]](http://arxiv.org/abs/2410.18336) `2024-10-24` (0 cite) (0 AI4Math cite) 
...
107. **From Blind Solvers to Logical Thinkers: Benchmarking LLMs' Logical Integrity on Faulty Mathematical Problems** [[pdf]](http://arxiv.org/abs/2410.18921) `2024-10-24` (0 cite) (0 AI4Math cite) 
...
108. **ReasonAgain: Using Extractable Symbolic Programs to Evaluate Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.19056) `2024-10-24` (0 cite) (0 AI4Math cite) 
...
109. **SIKeD: Self-guided Iterative Knowledge Distillation for mathematical reasoning** [[pdf]](http://arxiv.org/abs/2410.18574) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
110. **Unleashing Reasoning Capability of LLMs via Scalable Question Synthesis from Scratch** [[pdf]](http://arxiv.org/abs/2410.18693) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
111. **CLR-Bench: Evaluating Large Language Models in College-level Reasoning** [[pdf]](http://arxiv.org/abs/2410.17558) `2024-10-23` (0 cite) (0 AI4Math cite) 
...
112. **Markov Chain of Thought for Efficient Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.17635) `2024-10-23` (0 cite) (0 AI4Math cite) 
...
113. **R-CoT: Reverse Chain-of-Thought Problem Generation for Geometric Reasoning in Large Multimodal Models** [[pdf]](http://arxiv.org/abs/2410.17885) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
114. **Math Neurosurgery: Isolating Language Models' Math Reasoning Abilities Using Only Forward Passes** [[pdf]](http://arxiv.org/abs/2410.16930) `2024-10-22` (0 cite) (0 AI4Math cite) 
...
115. **Optimizing Chain-of-Thought Reasoning: Tackling Arranging Bottleneck via Plan Augmentation** [[pdf]](http://arxiv.org/abs/2410.16812) `2024-10-22` (0 cite) (0 AI4Math cite) 
...
116. **SMART: Self-learning Meta-strategy Agent for Reasoning Tasks** [[pdf]](http://arxiv.org/abs/2410.16128) `ICLR 2025 Submission` (1 cite) (0 AI4Math cite) 
...
117. **A Simple Model of Inference Scaling Laws** [[pdf]](http://arxiv.org/abs/2410.16377) `2024-10-21` (0 cite) (0 AI4Math cite) 
...
118. **A Theoretical Understanding of Chain-of-Thought: Coherent Reasoning and Error-Aware Demonstration** [[pdf]](http://arxiv.org/abs/2410.16540) `2024-10-21` (0 cite) (0 AI4Math cite) 
...
119. **Arithmetic Transformers Can Length-Generalize in Both Operand Length and Count** [[pdf]](http://arxiv.org/abs/2410.15787) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
120. **InternLM2.5-StepProver: Advancing Automated Theorem Proving via Expert Iteration on Large-Scale LEAN Problems** [[pdf]](http://arxiv.org/abs/2410.15700) `2024-10-21` `Lean` (0 cite) (0 AI4Math cite) 
...
121. **Language Models are Symbolic Learners in Arithmetic** [[pdf]](http://arxiv.org/abs/2410.15580) `2024-10-21` (0 cite) (0 AI4Math cite) 
...
122. **Pantograph: A Machine-to-Machine Interaction Interface for Advanced Theorem Proving, High Level Reasoning, and Data Extraction in Lean 4** [[pdf]](http://arxiv.org/abs/2410.16429) `2024-10-21` `Lean` (0 cite) (0 AI4Math cite) 
...
123. **ToW: Thoughts of Words Improve Reasoning in Large Language Models** [[pdf]](http://arxiv.org/abs/2410.16235) `2024-10-21` (0 cite) (0 AI4Math cite) 
...
124. **Keep Guessing? When Considering Inference Scaling, Mind the Baselines** [[pdf]](http://arxiv.org/abs/2410.15466) `2024-10-20` (0 cite) (0 AI4Math cite) 
...
125. **On Designing Effective RL Reward at Training Time for LLM Reasoning** [[pdf]](http://arxiv.org/abs/2410.15115) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
126. **Step Guided Reasoning: Improving Mathematical Reasoning using Guidance Generation and Step Reasoning** [[pdf]](http://arxiv.org/abs/2410.19817) `2024-10-18` (0 cite) (0 AI4Math cite) 
...
127. **A Comparative Study on Reasoning Patterns of OpenAI's o1 Model** [[pdf]](http://arxiv.org/abs/2410.13639) `2024-10-17` (0 cite) (0 AI4Math cite) 
...
128. **GeoCoder: Solving Geometry Problems by Generating Modular Code through Vision-Language Models** [[pdf]](http://arxiv.org/abs/2410.13510) `2024-10-17` (0 cite) (0 AI4Math cite) 
...
129. **How Numerical Precision Affects Mathematical Reasoning Capabilities of LLMs** [[pdf]](http://arxiv.org/abs/2410.13857) `2024-10-17` (0 cite) (0 AI4Math cite) 
...
130. **Proof Flow: Preliminary Study on Generative Flow Network Language Model Tuning for Formal Reasoning** [[pdf]](http://arxiv.org/abs/2410.13224) `2024-10-17` `Lean` (0 cite) (0 AI4Math cite) 
...
131. **The Geometry of Numerical Reasoning: Language Models Compare Numeric Properties in Linear Subspaces** [[pdf]](http://arxiv.org/abs/2410.13194) `2024-10-17` (0 cite) (0 AI4Math cite) 
...
132. **Enhancing Mathematical Reasoning in LLMs by Stepwise Correction** [[pdf]](http://arxiv.org/abs/2410.12934) `2024-10-16` (0 cite) (0 AI4Math cite) 
...
133. **Not All Votes Count! Programs as Verifiers Improve Self-Consistency of Language Models for Math Reasoning** [[pdf]](http://arxiv.org/abs/2410.12608) `2024-10-16` (0 cite) (0 AI4Math cite) 
...
134. **Reversal of Thought: Enhancing Large Language Models with Preference-Guided Reverse Reasoning Warm-up** [[pdf]](http://arxiv.org/abs/2410.12323) `2024-10-16` (0 cite) (0 AI4Math cite) 
...
135. **When Not to Answer: Evaluating Prompts on GPT Models for Effective Abstention in Unanswerable Math Word Problems** [[pdf]](http://arxiv.org/abs/2410.13029) `2024-10-16` (0 cite) (0 AI4Math cite) 
...
136. **Language Models Encode Numbers Using Digit Representations in Base 10** [[pdf]](http://arxiv.org/abs/2410.11781) `2024-10-15` (0 cite) (0 AI4Math cite) 
...
137. **MIND: Math Informed syNthetic Dialogues for Pretraining LLMs** [[pdf]](http://arxiv.org/abs/2410.12881) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
138. **How to Leverage Demonstration Data in Alignment for Large Language Model? A Self-Imitation Learning Perspective** [[pdf]](http://arxiv.org/abs/2410.10093) `2024-10-14` (1 cite) (0 AI4Math cite) 
...
139. **3D-Prover: Diversity Driven Theorem Proving With Determinantal Point Processes** [[pdf]](http://arxiv.org/abs/2410.11133) `ICLR 2025 Submission` `Lean` (0 cite) (0 AI4Math cite) 
...
140. **CoMAT: Chain of Mathematically Annotated Thought Improves Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.10336) `2024-10-14` (0 cite) (0 AI4Math cite) 
...
141. **Embedding Self-Correction as an Inherent Ability in Large Language Models for Enhanced Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.10735) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
142. **FLARE: Faithful Logic-Aided Reasoning and Exploration** [[pdf]](http://arxiv.org/abs/2410.11900) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
143. **Dualformer: Controllable Fast and Slow Thinking by Learning with Randomized Reasoning Traces** [[pdf]](http://arxiv.org/abs/2410.09918) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
144. **Expanding Search Space with Diverse Prompting Agents: An Efficient Sampling Approach for LLM Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.09780) `2024-10-13` (0 cite) (0 AI4Math cite) 
...
145. **HARDMath: A Benchmark Dataset for Challenging Problems in Applied Mathematics** [[pdf]](http://arxiv.org/abs/2410.09988) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
146. **MIRAGE: Evaluating and Explaining Inductive Reasoning Process in Language Models** [[pdf]](http://arxiv.org/abs/2410.09542) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
147. **OpenR: An Open Source Framework for Advanced Reasoning with Large Language Models** [[pdf]](http://arxiv.org/abs/2410.09671) `2024-10-12` (0 cite) (0 AI4Math cite) 
...
148. **Enhancing Multi-Step Reasoning Abilities of Language Models through Direct Q-Function Optimization** [[pdf]](http://arxiv.org/abs/2410.09302) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
149. **Exploring the Role of Reasoning Structures for Constructing Proofs in Multi-Step Natural Language Reasoning with Large Language Models** [[pdf]](http://arxiv.org/abs/2410.08436) `2024-10-11` (0 cite) (0 AI4Math cite) 
...
150. **SuperCorrect: Supervising and Correcting Language Models with Error-Driven Insights** [[pdf]](http://arxiv.org/abs/2410.09008) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
151. **Testing GPT-4-o1-preview on math and science problems: A follow-up study** [[pdf]](http://arxiv.org/abs/2410.22340) `2024-10-11` (0 cite) (0 AI4Math cite) 
...
152. **Automatic Curriculum Expert Iteration for Reliable LLM Reasoning** [[pdf]](http://arxiv.org/abs/2410.07627) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
153. **Diversity of Thought Elicits Stronger Reasoning Capabilities in Multi-Agent Debate Frameworks** [[pdf]](http://arxiv.org/abs/2410.12853) `2024-10-10` (0 cite) (0 AI4Math cite) 
...
154. **Enhancing Language Model Reasoning via Weighted Reasoning in Self-Consistency** [[pdf]](http://arxiv.org/abs/2410.07839) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
155. **Executing Arithmetic: Fine-Tuning Large Language Models as Turing Machines** [[pdf]](http://arxiv.org/abs/2410.07896) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
156. **Flow-DPO: Improving LLM Mathematical Reasoning through Online Multi-Agent Learning** [[pdf]](https://openreview.net/forum?id=uwagVHmyNA) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
157. **Interleaving Text and Number Embeddings to Solve Mathemathics Problems** [[pdf]](https://openreview.net/forum?id=8cNJyqs45T) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
158. **Learning Mathematical Rules with Large Language Models** [[pdf]](https://openreview.net/forum?id=tIlDF5B6T4) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
159. **Machines and Mathematical Mutations: Using GNNs to Characterize Quiver Mutation Classes** [[pdf]](https://openreview.net/forum?id=SxeiWOp73E) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
160. **MathCoder2: Better Math Reasoning from Continued Pretraining on Model-translated Mathematical Code** [[pdf]](http://arxiv.org/abs/2410.08196) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
161. **Mining Math Conjectures from LLMs: A Pruning Approach** [[pdf]](https://openreview.net/forum?id=aYlKvzY6ob) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
162. **Omni-MATH: A Universal Olympiad Level Mathematic Benchmark For Large Language Models** [[pdf]](http://arxiv.org/abs/2410.07985) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
163. **Rewarding Progress: Scaling Automated Process Verifiers for LLM Reasoning** [[pdf]](http://arxiv.org/abs/2410.08146) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
164. **STEM-POM: Evaluating Language Models Math-Symbol Reasoning in Document Parsing** [[pdf]](https://openreview.net/forum?id=jErJ8kansp) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
165. **TPO: Aligning Large Language Models with Multi-branch & Multi-step Preference Trees** [[pdf]](http://arxiv.org/abs/2410.12854) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
166. **Teaching-Inspired Integrated Prompting Framework: A Novel Approach for Enhancing Reasoning in Large Language Models** [[pdf]](http://arxiv.org/abs/2410.08068) `2024-10-10` (0 cite) (0 AI4Math cite) 
...
167. **What Makes Large Language Models Reason in (Multi-Turn) Code Generation?** [[pdf]](http://arxiv.org/abs/2410.08105) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
168. **Emergent properties with repeated examples** [[pdf]](http://arxiv.org/abs/2410.07041) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
169. **Subtle Errors Matter: Preference Learning via Error-injected Self-editing** [[pdf]](http://arxiv.org/abs/2410.06638) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
170. **Towards Self-Improvement of LLMs via MCTS: Leveraging Stepwise Knowledge with Curriculum Preference Learning** [[pdf]](http://arxiv.org/abs/2410.06508) `2024-10-09` (0 cite) (0 AI4Math cite) 
...
171. **Beyond Captioning: Task-Specific Prompting for Improved VLM Performance in Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.05928) `2024-10-08` (0 cite) (0 AI4Math cite) 
...
172. **Give me a hint: Can LLMs take a hint to solve math problems?** [[pdf]](http://arxiv.org/abs/2410.05915) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
173. **LeanAgent: Lifelong Learning for Formal Theorem Proving** [[pdf]](http://arxiv.org/abs/2410.06209) `ICLR 2025 Submission` `Lean` (0 cite) (0 AI4Math cite) 
...
174. **GSM-Symbolic: Understanding the Limitations of Mathematical Reasoning in Large Language Models** [[pdf]](https://arxiv.org/abs/2410.05229v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
175. **ImProver: Agent-Based Automated Proof Optimization** [[pdf]](https://arxiv.org/abs/2410.04753v1) `ICLR 2025 Submission` `Lean` (0 cite) (0 AI4Math cite) 
...
176. **Reasoning Paths Optimization: Learning to Reason and Explore From Diverse Paths** [[pdf]](http://arxiv.org/abs/2410.10858) `2024-10-07` (0 cite) (0 AI4Math cite) 
...
177. **ErrorRadar: Benchmarking Complex Mathematical Reasoning of Multimodal Large Language Models Via Error Detection** [[pdf]](https://arxiv.org/abs/2410.04509v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
178. **MathHay: An Automated Benchmark for Long-Context Mathematical Reasoning in LLMs** [[pdf]](http://arxiv.org/abs/2410.04698) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
179. **Polymath: A Challenging Multi-modal Mathematical Reasoning Benchmark** [[pdf]](http://arxiv.org/abs/2410.14702) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
180. **Wrong-of-Thought: An Integrated Reasoning Framework with Multi-Perspective Verification and Wrong Information** [[pdf]](https://arxiv.org/abs/2410.04463v1) `2024-10-06` (0 cite) (0 AI4Math cite) 
...
181. **BloomWise: Enhancing Problem-Solving capabilities of Large Language Models using Bloom's-Taxonomy-Inspired Prompts** [[pdf]](https://arxiv.org/abs/2410.04094v1) `2024-10-05` (0 cite) (0 AI4Math cite) 
...
182. **Consistent Autoformalization for Constructing Mathematical Libraries** [[pdf]](http://arxiv.org/abs/2410.04194) `2024-10-05` `Isabelle` (0 cite) (0 AI4Math cite) 
...
183. **Improving LLM Reasoning through Scaling Inference Computation with Collaborative Verification** [[pdf]](http://arxiv.org/abs/2410.05318) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
184. **Alchemy: Amplifying Theorem-Proving Capability through Symbolic Mutation** [[pdf]](https://openreview.net/forum?id=7NL74jUiMg) `ICLR 2025 Submission` `Lean` (0 cite) (0 AI4Math cite) 
...
185. **B-STaR: Monitoring and Balancing Exploration and Exploitation in Self-Taught Reasoners** [[pdf]](https://openreview.net/forum?id=P6dwZJpJ4m) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
186. **DOTS: Learning to Reason Dynamically in LLMs via Optimal Reasoning Trajectories Search** [[pdf]](http://arxiv.org/abs/2410.03864) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
187. **Deliberate Reasoning for LLMs as Structure-aware Planning with Accurate World Model** [[pdf]](https://arxiv.org/abs/2410.03136v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
188. **FormalAlign: Automated Alignment Evaluation for Autoformalization** [[pdf]](https://openreview.net/forum?id=B5RrIFMqbe) `ICLR 2025 Submission` `Lean` (0 cite) (0 AI4Math cite) 
...
189. **GeoX: Geometric Problem Solving Through Unified Formalized Vision-Language Pre-training** [[pdf]](https://openreview.net/forum?id=6RiBl5sCDF) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
190. **Hint Marginalization for Improved Reasoning in Large Language Models** [[pdf]](https://openreview.net/forum?id=DzKdjWe59v) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
191. **Inference-Aware Fine-Tuning for Best-of-N Sampling in Large Language Models** [[pdf]](https://openreview.net/forum?id=77gQUdQhE7) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
192. **MathGAP: Out-of-Distribution Evaluation on Problems with Arbitrarily Complex Proofs** [[pdf]](https://openreview.net/forum?id=5ck9PIrTpH) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
193. **Number Cookbook: Number Understanding of Language Models and How to Improve It** [[pdf]](https://openreview.net/forum?id=BWS5gVjgeY) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
195. **Seq-VCR: Preventing Collapse in Intermediate Transformer Representations for Enhanced Reasoning** [[pdf]](https://openreview.net/forum?id=30oIfmrcFO) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
196. **Steering Large Language Models between Code Execution and Textual Reasoning** [[pdf]](https://arxiv.org/abs/2410.03524v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
197. **System 2 reasoning capabilities are nigh** [[pdf]](https://arxiv.org/abs/2410.03662v1) `2024-10-04` (0 cite) (0 AI4Math cite) 
...
198. **U-MATH: A University-Level Benchmark for Evaluating Mathematical Skills in LLMs** [[pdf]](https://openreview.net/forum?id=xlxGsX1pc7) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
199. **VerifierQ: Enhancing LLM Test Time Compute with Q-Learning-based Verifiers** [[pdf]](https://openreview.net/forum?id=OD9pwKQzXl) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
200. **ZIP-FIT: Embedding-Free Data Selection via Compression-Based Alignment** [[pdf]](https://openreview.net/forum?id=4JBEpP6eRS) `ICLR 2025 Submission` `Lean` (0 cite) (0 AI4Math cite) 
...
201. **Adaptive Inference-Time Compute: LLMs Can Predict if They Can Do Better, Even Mid-Generation** [[pdf]](https://arxiv.org/abs/2410.02725v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
202. **CodePMP: Scalable Preference Model Pretraining for Large Language Model Reasoning** [[pdf]](http://arxiv.org/abs/2410.02229) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
203. **GraphIC: A Graph-Based In-Context Example Retrieval Model for Multi-Step Reasoning** [[pdf]](http://arxiv.org/abs/2410.02203) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
204. **LLaMA-Berry: Pairwise Optimization for O1-like Olympiad-Level Mathematical Reasoning** [[pdf]](https://arxiv.org/abs/2410.02884v1) `2024-10-03` (0 cite) (0 AI4Math cite) 
...
205. **The Role of Deductive and Inductive Reasoning in Large Language Models** [[pdf]](https://arxiv.org/abs/2410.02892v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
206. **Unlocking Structured Thinking in Language Models with Cognitive Prompting** [[pdf]](https://arxiv.org/abs/2410.02953v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
207. **Can We Further Elicit Reasoning in LLMs? Critic-Guided Planning with Retrieval-Augmentation for Solving Challenging Tasks** [[pdf]](http://arxiv.org/abs/2410.01428) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
208. **CreDes: Causal Reasoning Enhancement and Dual-End Searching for Solving Long-Range Reasoning Problems using LLMs** [[pdf]](http://arxiv.org/abs/2410.01696) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
209. **Evaluating Robustness of Reward Models for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2410.01729) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
210. **Interpretable Contrastive Monte Carlo Tree Search Reasoning** [[pdf]](http://arxiv.org/abs/2410.01707) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
211. **Layer Swapping for Zero-Shot Cross-Lingual Transfer in Large Language Models** [[pdf]](http://arxiv.org/abs/2410.01335) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
212. **Not All LLM Reasoners Are Created Equal** [[pdf]](http://arxiv.org/abs/2410.01748) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
213. **OpenMathInstruct-2: Accelerating AI for Math with Massive Open-Source Instruction Data** [[pdf]](http://arxiv.org/abs/2410.01560) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
214. **PersonaMath: Enhancing Math Reasoning through Persona-Driven Data Augmentation** [[pdf]](http://arxiv.org/abs/2410.01504) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
215. **ReGenesis: LLMs can Grow into Reasoning Generalists via Self-Improvement** [[pdf]](http://arxiv.org/abs/2410.02108) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
216. **Reasoning Elicitation in Language Models via Counterfactual Feedback** [[pdf]](http://arxiv.org/abs/2410.03767) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
217. **Step-by-Step Reasoning for Math Problems via Twisted Sequential Monte Carlo** [[pdf]](http://arxiv.org/abs/2410.01920) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
218. **TypedThinker: Typed Thinking Improves Large Language Model Reasoning** [[pdf]](http://arxiv.org/abs/2410.01952) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
219. **VinePPO: Unlocking RL Potential For LLM Reasoning Through Refined Credit Assignment** [[pdf]](http://arxiv.org/abs/2410.01679) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
220. **When a language model is optimized for reasoning, does it still show embers of autoregression? An analysis of OpenAI o1** [[pdf]](http://arxiv.org/abs/2410.01792) `2024-10-02` (0 cite) (0 AI4Math cite) 
...
221. **RATIONALYST: Pre-training Process-Supervision for Improving Reasoning** [[pdf]](http://arxiv.org/abs/2410.01044) `2024-10-01` (0 cite) (0 AI4Math cite) 
...
222. **Scheherazade: Evaluating Chain-of-Thought Math Reasoning in LLMs with Chain-of-Problems** [[pdf]](http://arxiv.org/abs/2410.00151) `2024-09-30` (0 cite) (0 AI4Math cite) 
...
223. **The Perfect Blend: Redefining RLHF with Mixture of Judges** [[pdf]](http://arxiv.org/abs/2409.20370) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
224. **BEATS: Optimizing LLM Mathematical Capabilities with BackVerify and Adaptive Disambiguate based Efficient Tree Search** [[pdf]](http://arxiv.org/abs/2409.17972) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
225. **Learning to Love Edge Cases in Formative Math Assessment: Using the AMMORE Dataset and Chain-of-Thought Prompting to Improve Grading Accuracy** [[pdf]](http://arxiv.org/abs/2409.17904) `2024-09-26` (0 cite) (0 AI4Math cite) 
...
226. **SciDFM: A Large Language Model with Mixture-of-Experts for Science** [[pdf]](http://arxiv.org/abs/2409.18412) `2024-09-26` (0 cite) (0 AI4Math cite) 
...
227. **Looped Transformers for Length Generalization** [[pdf]](http://arxiv.org/abs/2409.15647) `NeurIPS 2024 Workshop MATH-AI` (1 cite) (0 AI4Math cite) 
...
228. **HDFlow: Enhancing LLM Complex Problem-Solving with Hybrid Thinking and Dynamic Workflows** [[pdf]](http://arxiv.org/abs/2409.17433) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
229. **LLaMa-SciQ: An Educational Chatbot for Answering Science MCQ** [[pdf]](http://arxiv.org/abs/2409.16779) `2024-09-25` (0 cite) (0 AI4Math cite) 
...
230. **MathDSL: A Domain-Specific Language for Concise Mathematical Solutions Via Program Synthesis** [[pdf]](http://arxiv.org/abs/2409.17490) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
231. **Models Can and Should Embrace the Communicative Nature of Human-Generated Math** [[pdf]](http://arxiv.org/abs/2409.17005) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
232. **Proof Automation with Large Language Models** [[pdf]](https://arxiv.org/abs/2409.14274v1) `2024-09-22` `Coq` (0 cite) (0 AI4Math cite) 
...
233. **GroupDebate: Enhancing the Efficiency of Multi-Agent Debate Using Group Discussion** [[pdf]](http://arxiv.org/abs/2409.14051) `2024-09-21` (0 cite) (0 AI4Math cite) 
...
234. **Uncovering Latent Chain of Thought Vectors in Language Models** [[pdf]](http://arxiv.org/abs/2409.14026) `2024-09-21` (0 cite) (0 AI4Math cite) 
...
235. **CSCE: Boosting LLM Reasoning by Simultaneous Enhancing of Casual Significance and Consistency** [[pdf]](http://arxiv.org/abs/2409.17174) `2024-09-20` (1 cite) (0 AI4Math cite) 
...
236. **Neural-Symbolic Collaborative Distillation: Advancing Small Language Models for Complex Reasoning Tasks** [[pdf]](http://arxiv.org/abs/2409.13203) `2024-09-20` (0 cite) (0 AI4Math cite) 
...
237. **Training Language Models to Self-Correct via Reinforcement Learning** [[pdf]](http://arxiv.org/abs/2409.12917) `ICLR 2025 Submission` (9 cite) (0 AI4Math cite) 
...
238. **CodePlan: Unlocking Reasoning Potential in Large Langauge Models by Scaling Code-form Planning** [[pdf]](http://arxiv.org/abs/2409.12452) `2024-09-19` (0 cite) (0 AI4Math cite) 
...
239. **ControlMath: Controllable Data Generation Promotes Math Generalist Models** [[pdf]](http://arxiv.org/abs/2409.15376) `2024-09-19` (0 cite) (0 AI4Math cite) 
...
240. **InfiMM-WebMath-40B: Advancing Multimodal Pre-Training for Enhanced Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2409.12568) `NeurIPS 2024 Workshop MATH-AI` (0 cite) (0 AI4Math cite) 
...
241. **Iteration of Thought: Leveraging Inner Dialogue for Autonomous Large Language Model Reasoning** [[pdf]](http://arxiv.org/abs/2409.12618) `2024-09-19` (0 cite) (0 AI4Math cite) 
...
242. **LogicPro: Improving Complex Logical Reasoning via Program-Guided Learning** [[pdf]](http://arxiv.org/abs/2409.12929) `2024-09-19` (0 cite) (0 AI4Math cite) 
...
243. **System 2 thinking in OpenAI's o1-preview model: Near-perfect performance on a mathematics exam** [[pdf]](http://arxiv.org/abs/2410.07114) `2024-09-19` (0 cite) (0 AI4Math cite) 
...
244. **Textualized Agent-Style Reasoning for Complex Tasks by Multiple Round LLM Generation** [[pdf]](https://arxiv.org/abs/2409.12411v1) `2024-09-19` (0 cite) (0 AI4Math cite) 
...
245. **To CoT or not to CoT? Chain-of-thought helps mainly on math and symbolic reasoning** [[pdf]](https://arxiv.org/abs/2409.12183v1) `ICLR 2025 Submission` (5 cite) (0 AI4Math cite) 
...
246. **Qwen2.5-Math Technical Report: Toward Mathematical Expert Model via Self-Improvement** [[pdf]](https://arxiv.org/abs/2409.12122v1) `2024-09-18` (3 cite) (0 AI4Math cite) 
...
247. **Enhancing Logical Reasoning in Large Language Models through Graph-based Synthetic Data** [[pdf]](http://arxiv.org/abs/2409.12437) `2024-09-18` (0 cite) (0 AI4Math cite) 
...
248. **MAgICoRe: Multi-Agent, Iterative, Coarse-to-Fine Refinement for Reasoning** [[pdf]](https://arxiv.org/abs/2409.12147v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
249. **Small Language Models are Equation Reasoners** [[pdf]](http://arxiv.org/abs/2409.12393) `2024-09-18` (0 cite) (0 AI4Math cite) 
...
250. **Improving LLM Reasoning with Multi-Agent Tree-of-Thought Validator Agent** [[pdf]](https://arxiv.org/abs/2409.11527v1) `2024-09-17` (0 cite) (0 AI4Math cite) 
...
251. **Reasoning Graph Enhanced Exemplars Retrieval for In-Context Learning** [[pdf]](http://arxiv.org/abs/2409.11147) `2024-09-17` (0 cite) (0 AI4Math cite) 
...
252. **RoMath: A Mathematical Reasoning Benchmark in Romanian** [[pdf]](http://arxiv.org/abs/2409.11074) `2024-09-17` (0 cite) (0 AI4Math cite) 
...
253. **On the Diagram of Thought** [[pdf]](http://arxiv.org/abs/2409.10038) `2024-09-16` (2 cite) (0 AI4Math cite) 
...
254. **CPL: Critical Planning Step Learning Boosts LLM Generalization in Reasoning Tasks** [[pdf]](http://arxiv.org/abs/2409.08642) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
255. **Expediting and Elevating Large Language Model Reasoning via Hidden Chain-of-Thought Decoding** [[pdf]](http://arxiv.org/abs/2409.08561) `2024-09-13` (0 cite) (0 AI4Math cite) 
...
256. **Can We Count on LLMs? The Fixed-Effect Fallacy and Claims of GPT-4 Capabilities** [[pdf]](http://arxiv.org/abs/2409.07638) `2024-09-11` (0 cite) (0 AI4Math cite) 
...
257. **MathGLM-Vision: Solving Mathematical Problems with Multi-Modal Large Language Model** [[pdf]](http://arxiv.org/abs/2409.13729) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
258. **VisScience: An Extensive Benchmark for Evaluating K12 Educational Multi-modal Scientific Reasoning** [[pdf]](http://arxiv.org/abs/2409.13730) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
259. **Diagram Formalization Enhanced Multi-Modal Geometry Problem Solver** [[pdf]](http://arxiv.org/abs/2409.04214) `2024-09-06` (0 cite) (0 AI4Math cite) 
...
260. **From Calculation to Adjudication: Examining LLM judges on Mathematical Reasoning Tasks** [[pdf]](http://arxiv.org/abs/2409.04168) `2024-09-06` (0 cite) (0 AI4Math cite) 
...
261. **Self-Harmonized Chain of Thought** [[pdf]](http://arxiv.org/abs/2409.04057) `2024-09-06` (0 cite) (0 AI4Math cite) 
...
262. **Strategic Chain-of-Thought: Guiding Accurate Reasoning in LLMs through Strategy Elicitation** [[pdf]](http://arxiv.org/abs/2409.03271) `2024-09-05` (1 cite) (0 AI4Math cite) 
...
263. **Building Math Agents with Multi-Turn Iterative Preference Learning** [[pdf]](https://arxiv.org/abs/2409.02392v1) `ICLR 2025 Submission` (5 cite) (0 AI4Math cite) 
...
264. **CMM-Math: A Chinese Multimodal Math Dataset To Evaluate and Enhance the Mathematics Reasoning of Large Multimodal Models** [[pdf]](https://arxiv.org/abs/2409.02834v1) `2024-09-04` (0 cite) (0 AI4Math cite) 
...
265. **Deconfounded Causality-aware Parameter-Efficient Fine-Tuning for Problem-Solving Improvement of LLMs** [[pdf]](https://arxiv.org/abs/2409.02686v1) `2024-09-04` (0 cite) (0 AI4Math cite) 
...
266. **S$^3$c-Math: Spontaneous Step-level Self-correction Makes Large Language Models Better Mathematical Reasoners** [[pdf]](http://arxiv.org/abs/2409.01524) `2024-09-02` (0 cite) (0 AI4Math cite) 
...
267. **CoqPilot, a plugin for LLM-based generation of proofs** [[pdf]](https://arxiv.org/abs/2410.19605) `2024-09-01` `Coq` (0 cite) (0 AI4Math cite) 
...
268. **Dynamic Self-Consistency: Leveraging Reasoning Paths for Efficient LLM Sampling** [[pdf]](http://arxiv.org/abs/2408.17017) `2024-08-30` (1 cite) (0 AI4Math cite) 
...
269. **MultiMath: Bridging Visual and Mathematical Reasoning for Large Language Models** [[pdf]](http://arxiv.org/abs/2409.00147) `2024-08-30` (0 cite) (0 AI4Math cite) 
...
270. **Physics of Language Models: Part 2.2, How to Learn From Mistakes on Grade-School Math Problems** [[pdf]](http://arxiv.org/abs/2408.16293) `2024-08-29` (5 cite) (0 AI4Math cite) 
...
271. **Critic-CoT: Boosting the reasoning abilities of large language model via Chain-of-thoughts Critic** [[pdf]](http://arxiv.org/abs/2408.16326) `2024-08-29` (1 cite) (0 AI4Math cite) 
...
272. **Logic Contrastive Reasoning with Lightweight Large Language Model for Math Word Problems** [[pdf]](http://arxiv.org/abs/2409.00131) `2024-08-29` (0 cite) (0 AI4Math cite) 
...
273. **AutoGeo: Automating Geometric Image Dataset Creation for Enhanced Geometry Understanding** [[pdf]](http://arxiv.org/abs/2409.09039) `2024-08-28` (0 cite) (0 AI4Math cite) 
...
274. **SIaM: Self-Improving Code-Assisted Mathematical Reasoning of Large Language Models** [[pdf]](https://arxiv.org/abs/2408.15565v1) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
275. **Generative Verifiers: Reward Modeling as Next-Token Prediction** [[pdf]](http://arxiv.org/abs/2408.15240) `NeurIPS 2024 Workshop MATH-AI` (8 cite) (0 AI4Math cite) 
...
276. **What makes math problems hard for reinforcement learning: a case study** [[pdf]](https://arxiv.org/abs/2408.15332v1) `2024-08-27` (0 cite) (0 AI4Math cite) 
...
277. **Multi-tool Integration Application for Math Reasoning Using Large Language Model** [[pdf]](https://arxiv.org/abs/2408.12148v1) `2024-08-22` (0 cite) (0 AI4Math cite) 
...
278. **Positional Description for Numerical Normalization** [[pdf]](https://arxiv.org/abs/2408.12430v1) `INTERSPEECH 2024 Speech Synthesis` (0 cite) (0 AI4Math cite) 
...
279. **EAGLE: Elevating Geometric Reasoning through LLM-empowered Visual Instruction Tuning** [[pdf]](https://arxiv.org/abs/2408.11397v1) `2024-08-21` (1 cite) (0 AI4Math cite) 
...
280. **Benchmarking Large Language Models for Math Reasoning Tasks** [[pdf]](https://arxiv.org/abs/2408.10839v1) `2024-08-20` (0 cite) (0 AI4Math cite) 
...
281. **SubgoalXL: Subgoal-based Expert Learning for Theorem Proving** [[pdf]](https://arxiv.org/abs/2408.11172v1) `ICLR 2025 Submission` `Isabelle` (0 cite) (0 AI4Math cite) 
...
282. **Concept Distillation from Strong to Weak Models via Hypotheses-to-Theories Prompting** [[pdf]](https://arxiv.org/abs/2408.09365v1) `2024-08-18` (0 cite) (0 AI4Math cite) 
...
283. **Math-PUMA: Progressive Upward Multimodal Alignment to Enhance Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2408.08640) `2024-08-16` (1 cite) (0 AI4Math cite) 
...
284. **DeepSeek-Prover-V1.5: Harnessing Proof Assistant Feedback for Reinforcement Learning and Monte-Carlo Tree Search** [[pdf]](http://arxiv.org/abs/2408.08152) `2024-08-15` `Lean` (8 cite) (0 AI4Math cite) 
...
285. **Automated Design of Agentic Systems** [[pdf]](http://arxiv.org/abs/2408.08435) `ICLR 2025 Submission` (4 cite) (0 AI4Math cite) 
...
286. **V-STaR: Training Verifiers for Self-Taught Reasoners** [[pdf]](http://arxiv.org/abs/2402.06457) `COLM 2024` (47 cite) (2 AI4Math cite) 
...
287. **MathScape: Evaluating MLLMs in multimodal Math Scenarios through a Hierarchical Benchmark** [[pdf]](https://arxiv.org/abs/2408.07543v3) `2024-08-14` (1 cite) (0 AI4Math cite) 
...
288. **Mutual Reasoning Makes Smaller LLMs Stronger Problem-Solvers** [[pdf]](https://arxiv.org/abs/2408.06195v1) `2024-08-12` (6 cite) (0 AI4Math cite) 
...
289. **InfinityMATH: A Scalable Instruction Tuning Dataset in Programmatic Mathematical Reasoning** [[pdf]](https://arxiv.org/abs/2408.07089v1) `2024-08-09` (1 cite) (0 AI4Math cite) 
...
290. **Evaluating Language Model Math Reasoning via Grounding in Educational Curricula** [[pdf]](https://arxiv.org/abs/2408.04226v2) `2024-08-08` (1 cite) (0 AI4Math cite) 
...
291. **miniCTX: Neural Theorem Proving with (Long-)Contexts** [[pdf]](https://arxiv.org/abs/2408.03350v1) `NeurIPS 2024 Workshop MATH-AI` `Lean` (2 cite) (0 AI4Math cite) 
...
292. **MathLearner: A Large Language Model Agent Framework for Learning to Solve Mathematical Problems** [[pdf]](http://arxiv.org/abs/2408.01779) `2024-08-03` (0 cite) (0 AI4Math cite) 
...
293. **GeoEval: Benchmark for Evaluating LLMs and Multi-Modal Models on Geometry Problem-Solving** [[pdf]](https://aclanthology.org/2024.findings-acl.73) `ACL 2024 Findings` (8 cite) (0 AI4Math cite) 
...
294. **Small Language Models Need Strong Verifiers to Self-Correct Reasoning** [[pdf]](https://aclanthology.org/2024.findings-acl.924) `ACL 2024 Findings` (7 cite) (1 AI4Math cite) 
...
295. **SceMQA: A Scientific College Entrance Level Multimodal Question Answering Benchmark** [[pdf]](https://aclanthology.org/2024.acl-short.11) `ACL 2024 Short Papers` (6 cite) (0 AI4Math cite) 
...
296. **LANS: A Layout-Aware Neural Solver for Plane Geometry Problem** [[pdf]](https://aclanthology.org/2024.findings-acl.153) `ACL 2024 Findings` (5 cite) (0 AI4Math cite) 
...
297. **Distilling Mathematical Reasoning Capabilities into Small Language Models** [[pdf]](http://arxiv.org/abs/2401.11864) `2024-08-01` (3 cite) (0 AI4Math cite) 
...
298. **Meta-Reasoning: Semantics-Symbol Deconstruction for Large Language Models** [[pdf]](https://aclanthology.org/2024.findings-acl.34) `ACL 2024 Findings` (3 cite) (0 AI4Math cite) 
...
299. **Prover-Verifier Games improve legibility of LLM outputs** [[pdf]](http://arxiv.org/abs/2407.13692) `ICLR 2025 Submission` (3 cite) (0 AI4Math cite) 
...
300. **Evaluating LLMs’ Mathematical Reasoning in Financial Document Question Answering** [[pdf]](https://aclanthology.org/2024.findings-acl.231) `ACL 2024 Findings` (2 cite) (0 AI4Math cite) 
...
301. **BBA: Bi-Modal Behavioral Alignment for Reasoning with Large Vision-Language Models** [[pdf]](https://aclanthology.org/2024.findings-acl.433) `ACL 2024 Findings` (0 cite) (0 AI4Math cite) 
...
302. **Bi-Chainer: Automated Large Language Models Reasoning with Bidirectional Chaining** [[pdf]](https://aclanthology.org/2024.findings-acl.507) `ACL 2024 Findings` (0 cite) (0 AI4Math cite) 
...
303. **Language Models Do Hard Arithmetic Tasks Easily and Hardly Do Easy Arithmetic Tasks** [[pdf]](https://aclanthology.org/2024.acl-short.8) `ACL 2024 Short Papers` (0 cite) (0 AI4Math cite) 
...
304. **NUMCoT: Numerals and Units of Measurement in Chain-of-Thought Reasoning using Large Language Models** [[pdf]](https://aclanthology.org/2024.findings-acl.848) `ACL 2024 Findings` (0 cite) (0 AI4Math cite) 
...
305. **Question-Analysis Prompting Improves LLM Performance in Reasoning Tasks** [[pdf]](https://aclanthology.org/2024.acl-srw.45) `ACL 2024 Student Research Workshop` (0 cite) (0 AI4Math cite) 
...
306. **Large Language Monkeys: Scaling Inference Compute with Repeated Sampling** [[pdf]](http://arxiv.org/abs/2407.21787) `ICLR 2025 Submission` (21 cite) (0 AI4Math cite) 
...
307. **Inductive or Deductive? Rethinking the Fundamental Reasoning Abilities of LLMs** [[pdf]](https://arxiv.org/abs/2408.00114v2) `ICLR 2025 Submission` (2 cite) (0 AI4Math cite) 
...
308. **AI-Assisted Generation of Difficult Math Questions** [[pdf]](http://arxiv.org/abs/2407.21009) `NeurIPS 2024 Workshop MATH-AI` (3 cite) (0 AI4Math cite) 
...
309. **Key-Point-Driven Mathematical Reasoning Distillation of Large Language Model** [[pdf]](http://arxiv.org/abs/2407.10167) `2024-07-30` (0 cite) (0 AI4Math cite) 
...
310. **Physics of Language Models: Part 2.1, Grade-School Math and the Hidden Reasoning Process** [[pdf]](http://arxiv.org/abs/2407.20311) `2024-07-29` (8 cite) (0 AI4Math cite) 
...
311. **PATCH! Psychometrics-AssisTed benCHmarking of Large Language Models: A Case Study of Proficiency in 8th Grade Mathematics** [[pdf]](http://arxiv.org/abs/2404.01799) `2024-07-25` (0 cite) (0 AI4Math cite) 
...
312. **Relating the Seemingly Unrelated: Principled Understanding of Generalization for Generative Models in Arithmetic Reasoning Tasks** [[pdf]](https://arxiv.org/abs/2407.17963v1) `2024-07-25` (0 cite) (0 AI4Math cite) 
...
313. **LEAN-GitHub: Compiling GitHub LEAN repositories for a versatile LEAN prover** [[pdf]](http://arxiv.org/abs/2407.17227) `2024-07-24` `Lean` (3 cite) (0 AI4Math cite) 
...
314. **Boosting Large Language Models with Socratic Method for Conversational Mathematics Teaching** [[pdf]](https://arxiv.org/abs/2407.17349v1) `2024-07-24` (0 cite) (0 AI4Math cite) 
...
315. **MathViz-E: A Case-study in Domain-Specialized Tool-Using Agents** [[pdf]](http://arxiv.org/abs/2407.17544) `2024-07-24` (0 cite) (0 AI4Math cite) 
...
316. **Lean-STaR: Learning to Interleave Thinking and Proving** [[pdf]](http://arxiv.org/abs/2407.10040) `NeurIPS 2024 Workshop MATH-AI` `Lean` (3 cite) (0 AI4Math cite) 
...
317. **Q*: Improving Multi-step Reasoning for LLMs with Deliberative Planning** [[pdf]](http://arxiv.org/abs/2406.14283) `ICLR 2025 Submission` (4 cite) (0 AI4Math cite) 
...
318. **TaskGen: A Task-Based, Memory-Infused Agentic Framework using StrictJSON** [[pdf]](http://arxiv.org/abs/2407.15734) `2024-07-22` (0 cite) (0 AI4Math cite) 
...
319. **Reliable Reasoning Beyond Natural Language** [[pdf]](http://arxiv.org/abs/2407.11373) `2024-07-19` `Prolog` (1 cite) (0 AI4Math cite) 
...
320. **Learning From Correctness Without Prompting Makes LLM Efficient Reasoner** [[pdf]](http://arxiv.org/abs/2403.19094) `2024-07-18` (3 cite) (0 AI4Math cite) 
...
321. **Weak-to-Strong Reasoning** [[pdf]](http://arxiv.org/abs/2407.13647) `2024-07-18` (1 cite) (0 AI4Math cite) 
...
322. **Learning Goal-Conditioned Representations for Language Reward Models** [[pdf]](http://arxiv.org/abs/2407.13887) `2024-07-18` (0 cite) (0 AI4Math cite) 
...
323. **Encouraging Divergent Thinking in Large Language Models through Multi-Agent Debate** [[pdf]](http://arxiv.org/abs/2305.19118) `2024-07-17` (204 cite) (8 AI4Math cite) 
...
324. **DotaMath: Decomposition of Thought with Code Assistance and Self-correction for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2407.04078) `2024-07-17` (3 cite) (0 AI4Math cite) 
...
325. **Skywork-Math: Data Scaling Laws for Mathematical Reasoning in Large Language Models -- The Story Goes On** [[pdf]](http://arxiv.org/abs/2407.08348) `2024-07-17` (0 cite) (0 AI4Math cite) 
...
326. **Steamroller Problems: An Evaluation of LLM Reasoning Capability with Automated Theorem Prover Strategies** [[pdf]](https://arxiv.org/abs/2407.20244v1) `2024-07-17` (0 cite) (0 AI4Math cite) 
...
327. **Reasoning with Large Language Models, a Survey** [[pdf]](http://arxiv.org/abs/2407.11511) `2024-07-16` (1 cite) (0 AI4Math cite) 
...
328. **Diffusion of Thoughts: Chain-of-Thought Reasoning in Diffusion Language Models** [[pdf]](http://arxiv.org/abs/2402.07754) `2024-07-15` (1 cite) (0 AI4Math cite) 
...
329. **COMET: "Cone of experience" enhanced large multimodal model for mathematical problem generation** [[pdf]](http://arxiv.org/abs/2407.11315) `2024-07-15` (0 cite) (0 AI4Math cite) 
...
330. **Step-Controlled DPO: Leveraging Stepwise Error for Enhanced Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2407.00782) `2024-07-14` (5 cite) (0 AI4Math cite) 
...
331. **Stepwise Verification and Remediation of Student Reasoning Errors with Large Language Model Tutors** [[pdf]](https://arxiv.org/abs/2407.09136v1) `2024-07-12` (1 cite) (0 AI4Math cite) 
...
332. **Token-Supervised Value Models for Enhancing Mathematical Reasoning Capabilities of Large Language Models** [[pdf]](http://arxiv.org/abs/2407.12863) `2024-07-12` (0 cite) (0 AI4Math cite) 
...
333. **Is Your Model Really A Good Math Reasoner? Evaluating Mathematical Reasoning with Checklist** [[pdf]](http://arxiv.org/abs/2407.08733) `ICLR 2025 Submission` (4 cite) (0 AI4Math cite) 
...
334. **MAVIS: Mathematical Visual Instruction Tuning** [[pdf]](http://arxiv.org/abs/2407.08739) `2024-07-11` (3 cite) (0 AI4Math cite) 
...
335. **Exploring the Compositional Deficiency of Large Language Models in Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2405.06680) `2024-07-11` (2 cite) (0 AI4Math cite) 
...
336. **Self-training Language Models for Arithmetic Reasoning** [[pdf]](http://arxiv.org/abs/2407.08400) `2024-07-11` (0 cite) (0 AI4Math cite) 
...
337. **Fuse, Reason and Verify: Geometry Problem Solving with Parsed Clauses from Diagram** [[pdf]](https://arxiv.org/abs/2407.07327v1) `2024-07-10` (2 cite) (0 AI4Math cite) 
...
338. **Regularization in Spider-Style Strategy Discovery and Schedule Construction** [[pdf]](http://arxiv.org/abs/2403.12869) `2024-07-09` (3 cite) (0 AI4Math cite) 
...
339. **LLM Critics Help Catch Bugs in Mathematics: Towards a Better Mathematical Verifier with Natural Language Feedback** [[pdf]](http://arxiv.org/abs/2406.14024) `2024-07-08` (2 cite) (0 AI4Math cite) 
...
340. **Can Large Language Models Replicate ITS Feedback on Open-Ended Math Questions?** [[pdf]](http://arxiv.org/abs/2405.06414) `2024-07-08` (0 cite) (0 AI4Math cite) 
...
341. **Fill in the Blank: Exploring and Enhancing LLM Capabilities for Backward Reasoning in Math Word Problems** [[pdf]](http://arxiv.org/abs/2310.01991) `2024-07-07` (8 cite) (1 AI4Math cite) 
...
342. **LogicVista: Multimodal LLM Logical Reasoning Benchmark in Visual Contexts** [[pdf]](https://arxiv.org/abs/2407.04973v1) `ICLR 2025 Submission` (5 cite) (0 AI4Math cite) 
...
343. **Solving for X and Beyond: Can Large Language Models Solve Complex Math Problems with More-Than-Two Unknowns?** [[pdf]](https://arxiv.org/abs/2407.05134v1) `2024-07-06` (0 cite) (0 AI4Math cite) 
...
344. **Towards Automated Functional Equation Proving: A Benchmark Dataset and A Domain-Specific In-Context Agent** [[pdf]](https://arxiv.org/abs/2407.14521v1) `2024-07-05` `Lean` (0 cite) (0 AI4Math cite) 
...
345. **AgentInstruct: Toward Generative Teaching with Agentic Flows** [[pdf]](http://arxiv.org/abs/2407.03502) `2024-07-03` (4 cite) (0 AI4Math cite) 
...
346. **TheoremLlama: Transforming General-Purpose LLMs into Lean4 Experts** [[pdf]](http://arxiv.org/abs/2407.03203) `2024-07-03` `Lean` (2 cite) (0 AI4Math cite) 
...
347. **Artificial intelligence and machine learning generated conjectures with TxGraffiti** [[pdf]](https://arxiv.org/abs/2407.02731v1) `2024-07-03` (0 cite) (0 AI4Math cite) 
...
348. **We-Math: Does Your Large Multimodal Model Achieve Human-like Mathematical Reasoning?** [[pdf]](http://arxiv.org/abs/2407.01284) `2024-07-01` (6 cite) (0 AI4Math cite) 
...
349. **First-Step Advantage: Importance of Starting Right in Multi-Step Math Reasoning** [[pdf]](http://arxiv.org/abs/2311.07945) `ICLR 2025 Submission` (2 cite) (0 AI4Math cite) 
...
350. **MalAlgoQA: A Pedagogical Approach for Evaluating Counterfactual Reasoning Abilities** [[pdf]](https://arxiv.org/abs/2407.00938v1) `2024-07-01` (2 cite) (0 AI4Math cite) 
...
351. **FRoG: Evaluating Fuzzy Reasoning of Generalized Quantifiers in Large Language Models** [[pdf]](https://arxiv.org/abs/2407.01046v2) `2024-07-01` (0 cite) (0 AI4Math cite) 
...
352. **Mamo: a Mathematical Modeling Benchmark with Solvers** [[pdf]](http://arxiv.org/abs/2405.13144) `2024-06-30` (2 cite) (0 AI4Math cite) 
...
353. **MathCAMPS: Fine-grained Synthesis of Mathematical Problems From Human Curricula** [[pdf]](http://arxiv.org/abs/2407.00900) `NeurIPS 2024 Workshop MATH-AI` (1 cite) (0 AI4Math cite) 
...
354. **How to Leverage Digit Embeddings to Represent Numbers?** [[pdf]](http://arxiv.org/abs/2407.00894) `2024-06-30` (0 cite) (0 AI4Math cite) 
...
355. **LiteSearch: Efficacious Tree Search for LLM** [[pdf]](http://arxiv.org/abs/2407.00320) `2024-06-29` (2 cite) (0 AI4Math cite) 
...
356. **Advancing Process Verification for Large Language Models via Tree-Based Preference Learning** [[pdf]](https://arxiv.org/abs/2407.00390v1) `2024-06-29` (0 cite) (0 AI4Math cite) 
...
357. **CMMaTH: A Chinese Multi-modal Math Skill Evaluation Benchmark for Foundation Models** [[pdf]](https://arxiv.org/abs/2407.12023v1) `2024-06-28` (3 cite) (0 AI4Math cite) 
...
358. **LiveBench: A Challenging, Contamination-Free LLM Benchmark** [[pdf]](http://arxiv.org/abs/2406.19314) `ICLR 2025 Submission` (12 cite) (0 AI4Math cite) 
...
359. **DiVERT: Distractor Generation with Variational Errors Represented as Text for Math Multiple-choice Questions** [[pdf]](https://arxiv.org/abs/2406.19356v1) `2024-06-27` (1 cite) (0 AI4Math cite) 
...
360. **Evaluating LLMs' Mathematical and Coding Competency through Ontology-guided Interventions** [[pdf]](http://arxiv.org/abs/2401.09395) `2024-06-27` (1 cite) (0 AI4Math cite) 
...
361. **Step-DPO: Step-wise Preference Optimization for Long-chain Reasoning of LLMs** [[pdf]](https://arxiv.org/abs/2406.18629v1) `ICLR 2025 Submission` (7 cite) (0 AI4Math cite) 
...
362. **Math-LLaVA: Bootstrapping Mathematical Reasoning for Multimodal Large Language Models** [[pdf]](http://arxiv.org/abs/2406.17294) `2024-06-26` (5 cite) (0 AI4Math cite) 
...
363. **MindStar: Enhancing Math Reasoning in Pre-trained LLMs at Inference Time** [[pdf]](http://arxiv.org/abs/2405.16265) `2024-06-26` (4 cite) (0 AI4Math cite) 
...
364. **MathOdyssey: Benchmarking Mathematical Problem-Solving Skills in Large Language Models Using Odyssey Math Data** [[pdf]](http://arxiv.org/abs/2406.18321) `ICLR 2025 Submission` (1 cite) (0 AI4Math cite) 
...
365. **Multiple-Choice Questions are Efficient and Robust LLM Evaluators** [[pdf]](http://arxiv.org/abs/2405.11966) `2024-06-26` (1 cite) (0 AI4Math cite) 
...
366. **Improving Arithmetic Reasoning Ability of Large Language Models through Relation Tuples, Verification and Dynamic Feedback** [[pdf]](https://arxiv.org/abs/2406.17873v1) `2024-06-25` (1 cite) (0 AI4Math cite) 
...
367. **Task Oriented In-Domain Data Augmentation** [[pdf]](http://arxiv.org/abs/2406.16694) `2024-06-24` (1 cite) (0 AI4Math cite) 
...
368. **The Impact of Reasoning Step Length on Large Language Models** [[pdf]](http://arxiv.org/abs/2401.04925) `ACL 2024 Findings` (28 cite) (1 AI4Math cite) 
...
369. **RL on Incorrect Synthetic Data Scales the Efficiency of LLM Math Reasoning by Eight-Fold** [[pdf]](https://arxiv.org/abs/2406.14532v1) `2024-06-20` (10 cite) (0 AI4Math cite) 
...
370. **Can LLMs Reason in the Wild with Programs?** [[pdf]](http://arxiv.org/abs/2406.13764) `2024-06-19` (4 cite) (0 AI4Math cite) 
...
371. **Mathador-LM: A Dynamic Benchmark for Mathematical Reasoning on Large Language Models** [[pdf]](http://arxiv.org/abs/2406.12572) `2024-06-19` (0 cite) (0 AI4Math cite) 
...
372. **GeoGPT4V: Towards Geometric Multi-modal Large Language Models with Geometric Image Generation** [[pdf]](https://arxiv.org/abs/2406.11503v1) `2024-06-17` (3 cite) (0 AI4Math cite) 
...
373. **On the Empirical Complexity of Reasoning and Planning in LLMs** [[pdf]](http://arxiv.org/abs/2404.11041) `2024-06-17` (2 cite) (0 AI4Math cite) 
...
374. **Probabilistic Reasoning in Generative Large Language Models** [[pdf]](http://arxiv.org/abs/2402.09614) `2024-06-17` (2 cite) (0 AI4Math cite) 
...
375. **How Do Humans Write Code? Large Models Do It the Same Way Too** [[pdf]](http://arxiv.org/abs/2402.15729) `2024-06-17` (1 cite) (0 AI4Math cite) 
...
376. **Learn Beyond The Answer: Training Language Models with Reflection for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2406.12050) `2024-06-17` (0 cite) (0 AI4Math cite) 
...
377. **Mathematical Entities: Corpora and Benchmarks** [[pdf]](http://arxiv.org/abs/2406.11577) `2024-06-17` (0 cite) (0 AI4Math cite) 
...
378. **Step-level Value Preference Optimization for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2406.10858) `2024-06-16` (4 cite) (0 AI4Math cite) 
...
379. **Exposing the Achilles' Heel: Evaluating LLMs Ability to Handle Mistakes in Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2406.10834) `ICLR 2025 Submission` (0 cite) (0 AI4Math cite) 
...
380. **RUPBench: Benchmarking Reasoning Under Perturbations for Robustness Evaluation in Large Language Models** [[pdf]](http://arxiv.org/abs/2406.11020) `2024-06-16` (0 cite) (0 AI4Math cite) 
...
381. **Teaching Large Language Models to Reason with Reinforcement Learning** [[pdf]](https://openreview.net/forum?id=mjqoceuMnI) `ICML 2024 Workshop AI for Math` (24 cite) (1 AI4Math cite) 
...
382. **Accessing GPT-4 level Mathematical Olympiad Solutions via Monte Carlo Tree Self-refine with LLaMa-3 8B** [[pdf]](http://arxiv.org/abs/2406.07394) `2024-06-13` (9 cite) (0 AI4Math cite) 
...
383. **VerityMath: Advancing Mathematical Reasoning by Self-Verification Through Unit Consistency** [[pdf]](https://openreview.net/forum?id=S9utaRXaZt&name=pdf) `2024-06-13` (3 cite) (0 AI4Math cite) 
...
384. **Distilling LLMs' Decomposition Abilities into Compact Language Models** [[pdf]](https://openreview.net/forum?id=XM44SZM3VO&name=pdf) `2024-06-13` (2 cite) (0 AI4Math cite) 
...
385. **Progress or Regress? Self-Improvement Reversal in Post-training** [[pdf]](https://openreview.net/forum?id=MG18DR2dAN) `ICLR 2025 Submission` (2 cite) (0 AI4Math cite) 
...
386. **Pre-Calc: Learning to Use the Calculator Improves Numeracy in Language Models** [[pdf]](https://openreview.net/forum?id=Hb5gA02FyR&name=pdf) `2024-06-13` (0 cite) (0 AI4Math cite) 
...
387. **Smart Vision-Language Reasoners** [[pdf]](https://openreview.net/forum?id=Mf6ot5U7ni&name=pdf) `2024-06-13` (0 cite) (0 AI4Math cite) 
...
388. **Improving Autoformalization using Type Checking** [[pdf]](http://arxiv.org/abs/2406.07222) `2024-06-11` `Lean` (1 cite) (0 AI4Math cite) 
...
389. **Autograding Mathematical Induction Proofs with Natural Language Processing** [[pdf]](http://arxiv.org/abs/2406.10268) `2024-06-11` (0 cite) (0 AI4Math cite) 
...
390. **Husky: A Unified, Open-Source Language Agent for Multi-Step Reasoning** [[pdf]](http://arxiv.org/abs/2406.06469) `2024-06-10` (4 cite) (0 AI4Math cite) 
...
391. **LLMs Are Not Intelligent Thinkers: Introducing Mathematical Topic Tree Benchmark for Comprehensive Evaluation of LLMs** [[pdf]](http://arxiv.org/abs/2406.05194) `2024-06-07` (0 cite) (0 AI4Math cite) 
...
392. **Robustness Assessment of Mathematical Reasoning in the Presence of Missing and Contradictory Conditions** [[pdf]](http://arxiv.org/abs/2406.05055) `2024-06-07` (0 cite) (0 AI4Math cite) 
...
393. **Improve Mathematical Reasoning in Language Models by Automated Process Supervision** [[pdf]](http://arxiv.org/abs/2406.06592) `2024-06-05` (23 cite) (0 AI4Math cite) 
...
394. **MR-GSM8K: A Meta-Reasoning Benchmark for Large Language Model Evaluation** [[pdf]](http://arxiv.org/abs/2312.17080) `ICLR 2025 Submission` (3 cite) (0 AI4Math cite) 
...
395. **Assessing the Emergent Symbolic Reasoning Abilities of Llama Large Language Models** [[pdf]](http://arxiv.org/abs/2406.06588) `2024-06-05` (0 cite) (0 AI4Math cite) 
...
396. **Forward-Backward Reasoning in Large Language Models for Mathematical Verification** [[pdf]](http://arxiv.org/abs/2308.07758) `ACL 2024 Findings` (9 cite) (1 AI4Math cite) 
...
397. **Break the Chain: Large Language Models Can be Shortcut Reasoners** [[pdf]](http://arxiv.org/abs/2406.06580) `2024-06-04` (1 cite) (0 AI4Math cite) 
...
398. **Exploring Mathematical Extrapolation of Large Language Models with Synthetic Data** [[pdf]](http://arxiv.org/abs/2406.02100) `ACL 2024 Findings` (0 cite) (0 AI4Math cite) 
...
399. **Process-Driven Autoformalization in Lean 4** [[pdf]](http://arxiv.org/abs/2406.01940) `ICLR 2025 Submission` `Lean` (4 cite) (0 AI4Math cite) 
...
400. **Explicitly Encoding Structural Symmetry is Key to Length Generalization in Arithmetic Tasks** [[pdf]](http://arxiv.org/abs/2406.01895) `2024-06-03` (1 cite) (0 AI4Math cite) 
...
401. **Evaluating Mathematical Reasoning of Large Language Models: A Focus on Error Identification and Correction** [[pdf]](http://arxiv.org/abs/2406.00755) `ACL 2024 Findings` (5 cite) (0 AI4Math cite) 
...
402. **What Makes Math Word Problems Challenging for LLMs?** [[pdf]](https://aclanthology.org/2024.findings-naacl.72) `NAACL 2024 Findings` (4 cite) (0 AI4Math cite) 
...
403. **Arithmetic Reasoning with LLM: Prolog Generation & Permutation** [[pdf]](https://aclanthology.org/2024.naacl-short.61) `NAACL 2024 Short Papers` (2 cite) (0 AI4Math cite) 
...
404. **Laying Anchors: Semantically Priming Numerals in Language Modeling** [[pdf]](https://aclanthology.org/2024.findings-naacl.169) `NAACL 2024 Findings` (1 cite) (0 AI4Math cite) 
...
405. **An Evaluation Benchmark for Autoformalization in Lean4** [[pdf]](http://arxiv.org/abs/2406.06555) `2024-06-01` `Lean` (0 cite) (0 AI4Math cite) 
...
406. **GOLD: Geometry Problem Solver with Natural Language Description** [[pdf]](https://aclanthology.org/2024.findings-naacl.19) `NAACL 2024 Findings` (0 cite) (0 AI4Math cite) 
...
407. **Self-Demos: Eliciting Out-of-Demonstration Generalizability in Large Language Models** [[pdf]](https://aclanthology.org/2024.findings-naacl.243) `NAACL 2024 Findings` (0 cite) (0 AI4Math cite) 
...
408. **Beyond Imitation: Learning Key Reasoning Steps from Dual Chain-of-Thoughts in Reasoning Distillation** [[pdf]](http://arxiv.org/abs/2405.19737) `ICLR 2025 Submission` (3 cite) (0 AI4Math cite) 
...
409. **Investigating the Robustness of LLMs on Math Word Problems** [[pdf]](http://arxiv.org/abs/2406.15444) `2024-05-30` (3 cite) (0 AI4Math cite) 
...
410. **MathChat: Benchmarking Mathematical Reasoning and Instruction Following in Multi-Turn Interactions** [[pdf]](http://arxiv.org/abs/2405.19444) `2024-05-29` (2 cite) (0 AI4Math cite) 
...
411. **Achieving >97% on GSM8K: Deeply Understanding the Problems Makes LLMs Better Solvers for Math Word Problems** [[pdf]](http://arxiv.org/abs/2404.14963) `2024-05-29` (0 cite) (0 AI4Math cite) 
...
412. **Efficient Model-agnostic Alignment via Bayesian Persuasion** [[pdf]](http://arxiv.org/abs/2405.18718) `2024-05-28` (0 cite) (0 AI4Math cite) 
...
413. **Learning Beyond Pattern Matching? Assaying Mathematical Understanding in LLMs** [[pdf]](http://arxiv.org/abs/2405.15485) `2024-05-24` (1 cite) (0 AI4Math cite) 
...
414. **Rho-1: Not All Tokens Are What You Need** [[pdf]](http://arxiv.org/abs/2404.07965) `2024-05-23` (24 cite) (1 AI4Math cite) 
...
415. **DeepSeek-Prover: Advancing Theorem Proving in LLMs through Large-Scale Synthetic Data** [[pdf]](http://arxiv.org/abs/2405.14333) `2024-05-23` `Lean` (15 cite) (1 AI4Math cite) 
...
416. **Can LLMs Solve longer Math Word Problems Better?** [[pdf]](http://arxiv.org/abs/2405.14804) `2024-05-23` (1 cite) (0 AI4Math cite) 
...
417. **Large Language Models are Contrastive Reasoners** [[pdf]](http://arxiv.org/abs/2403.08211) `2024-05-22` (0 cite) (0 AI4Math cite) 
...
418. **Investigating Symbolic Capabilities of Large Language Models** [[pdf]](http://arxiv.org/abs/2405.13209) `2024-05-21` (2 cite) (0 AI4Math cite) 
...
419. **DOP: Diagnostic-Oriented Prompting for Large Language Models in Mathematical Correction** [[pdf]](http://arxiv.org/abs/2405.12100) `2024-05-20` (0 cite) (0 AI4Math cite) 
...
420. **Self-Explore to Avoid the Pit: Improving the Reasoning Capabilities of Language Models with Fine-grained Rewards** [[pdf]](http://arxiv.org/abs/2404.10346) `2024-05-16` (0 cite) (0 AI4Math cite) 
...
421. **Improving Automated Distractor Generation for Math Multiple-choice Questions with Overgenerate-and-rank** [[pdf]](http://arxiv.org/abs/2405.05144) `2024-05-13` (1 cite) (0 AI4Math cite) 
...
422. **MuMath-Code: Combining Tool-Use Large Language Models with Multi-perspective Data Augmentation for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2405.07551) `NAACL 2024 Findings` (1 cite) (0 AI4Math cite) 
...
423. **MathDivide: Improved mathematical reasoning by large language models** [[pdf]](http://arxiv.org/abs/2405.13004) `2024-05-12` (0 cite) (0 AI4Math cite) 
...
424. **Natural Language Reasoning, A Survey** [[pdf]](https://dl.acm.org/doi/10.1145/3664194) `2024-05-09` (36 cite) (0 AI4Math cite) 
...
425. **LLMs Can Find Mathematical Reasoning Mistakes by Pedagogical Chain-of-Thought** [[pdf]](http://arxiv.org/abs/2405.06705) `IJCAI 2024 Knowledge Representation and Reasoning` (1 cite) (1 AI4Math cite) 
...
426. **Learning to Solve Geometry Problems via Simulating Human Dual-Reasoning Process** [[pdf]](http://arxiv.org/abs/2405.06232) `IJCAI 2024 Natural Language Processing` (0 cite) (0 AI4Math cite) 
...
427. **Key-Point-Driven Data Synthesis with its Enhancement on Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2403.02333) `2024-05-07` (13 cite) (2 AI4Math cite) 
...
428. **ATG: Benchmarking Automated Theorem Generation for Generative Language Models** [[pdf]](http://arxiv.org/abs/2405.06677) `NAACL 2024 Findings` `MetaMath` (3 cite) (0 AI4Math cite) 
...
429. **Monte Carlo Tree Search Boosts Reasoning via Iterative Preference Learning** [[pdf]](https://arxiv.org/abs/2405.00451v2) `2024-05-01` (14 cite) (0 AI4Math cite) 
...
430. **Self-Refine Instruction-Tuning for Aligning Reasoning in Language Models** [[pdf]](http://arxiv.org/abs/2405.00402) `2024-05-01` (1 cite) (0 AI4Math cite) 
...
431. **General Purpose Verification for Chain of Thought Prompting** [[pdf]](http://arxiv.org/abs/2405.00204) `2024-04-30` (3 cite) (0 AI4Math cite) 
...
432. **Can Large Language Models put 2 and 2 together? Probing for Entailed Arithmetical Relationships** [[pdf]](https://arxiv.org/abs/2404.19432v1) `2024-04-30` (1 cite) (0 AI4Math cite) 
...
433. **Exploring Internal Numeracy in Language Models: A Case Study on ALBERT** [[pdf]](http://arxiv.org/abs/2404.16574) `2024-04-25` (1 cite) (0 AI4Math cite) 
...
434. **SAAS: Solving Ability Amplification Strategy for Enhanced Mathematical Reasoning in Large Language Models** [[pdf]](http://arxiv.org/abs/2404.03887) `2024-04-24` (0 cite) (0 AI4Math cite) 
...
435. **Describe-then-Reason: Improving Multimodal Mathematical Reasoning through Visual Comprehension Training** [[pdf]](https://arxiv.org/abs/2404.14604v3) `2024-04-22` (3 cite) (0 AI4Math cite) 
...
436. **FGeo-HyperGNet: Geometric Problem Solving Integrating Formal Symbolic System and Hypergraph Neural Network** [[pdf]](http://arxiv.org/abs/2402.11461) `2024-04-22` (0 cite) (0 AI4Math cite) 
...
437. **MARIO Eval: Evaluate Your Math LLM with your Math LLM--A mathematical dataset evaluation toolkit** [[pdf]](http://arxiv.org/abs/2404.13925) `2024-04-22` (0 cite) (0 AI4Math cite) 
...
438. **PARAMANU-GANITA: Language Model with Mathematical Capabilities** [[pdf]](http://arxiv.org/abs/2404.14395) `2024-04-22` (0 cite) (0 AI4Math cite) 
...
439. **Mathify: Evaluating Large Language Models on Mathematical Problem Solving Tasks** [[pdf]](http://arxiv.org/abs/2404.13099) `NeurIPS 2023 Workshop on Generative AI for Education` (7 cite) (0 AI4Math cite) 
...
440. **Enhancing Length Extrapolation in Sequential Models with Pointer-Augmented Neural Memory** [[pdf]](https://arxiv.org/abs/2404.11870v1) `2024-04-18` (0 cite) (0 AI4Math cite) 
...
441. **Beyond Human Data: Scaling Self-Training for Problem-Solving with Language Models** [[pdf]](http://arxiv.org/abs/2312.06585) `2024-04-17` (72 cite) (7 AI4Math cite) 
...
442. **Reformatted Alignment** [[pdf]](http://arxiv.org/abs/2402.12219) `2024-04-17` (6 cite) (1 AI4Math cite) 
...
443. **A Survey on Deep Learning for Theorem Proving** [[pdf]](http://arxiv.org/abs/2404.09939) `COLM 2024` (6 cite) (1 AI4Math cite) 
...
444. **Wu's Method can Boost Symbolic AI to Rival Silver Medalists and AlphaGeometry to Outperform Gold Medalists at IMO Geometry** [[pdf]](http://arxiv.org/abs/2404.06405) `2024-04-11` (3 cite) (0 AI4Math cite) 
...
445. **A Survey in Mathematical Language Processing** [[pdf]](http://arxiv.org/abs/2205.15231) `2024-04-08` (11 cite) (2 AI4Math cite) 
...
446. **Evaluating Mathematical Reasoning Beyond Accuracy** [[pdf]](http://arxiv.org/abs/2404.05692) `2024-04-08` (5 cite) (0 AI4Math cite) 
...
447. **FRACTAL: Fine-Grained Scoring from Aggregate Text Labels** [[pdf]](http://arxiv.org/abs/2404.04817) `2024-04-07` (0 cite) (0 AI4Math cite) 
...
448. **MM-MATH: Advancing Multimodal Math Evaluation with Process Evaluation and Fine-grained Classification** [[pdf]](https://arxiv.org/abs/2404.05091v4) `2024-04-07` (0 cite) (0 AI4Math cite) 
...
449. **Large Language Models for Mathematical Reasoning: Progresses and Challenges** [[pdf]](http://arxiv.org/abs/2402.00157) `EACL 2024 student research workshop` (53 cite) (1 AI4Math cite) 
...
450. **Data Augmentation with In-Context Learning and Comparative Evaluation in Math Word Problem Solving** [[pdf]](https://arxiv.org/abs/2404.03938v1) `2024-04-05` (0 cite) (0 AI4Math cite) 
...
451. **Proceedings 12th International Workshop on Theorem proving components for Educational software** [[pdf]](https://arxiv.org/abs/2404.03709v1) `2024-04-04` (0 cite) (0 AI4Math cite) 
...
452. **ChatGLM-Math: Improving Math Problem-Solving in Large Language Models with a Self-Critique Pipeline** [[pdf]](https://arxiv.org/abs/2404.02893v1) `2024-04-03` (18 cite) (2 AI4Math cite) 
...
453. **Advancing LLM Reasoning Generalists with Preference Trees** [[pdf]](http://arxiv.org/abs/2404.02078) `ICLR 2025 Submission` (41 cite) (3 AI4Math cite) 
...
454. **Autonomous Data Selection with Language Models for Mathematical Texts** [[pdf]](http://arxiv.org/abs/2402.07625) `ICLR 2024 Workshop DPFM` (15 cite) (2 AI4Math cite) 
...
455. **Large Language Models for Mathematicians** [[pdf]](http://arxiv.org/abs/2312.04556) `2024-04-02` (3 cite) (0 AI4Math cite) 
...
456. **$\texttt{LM}^\texttt{2}$: A Simple Society of Language Models Solves Complex Reasoning** [[pdf]](https://arxiv.org/abs/2404.02255v1) `2024-04-02` (0 cite) (0 AI4Math cite) 
...
457. **Enhancing Formal Theorem Proving: A Comprehensive Dataset for Training AI Models on Coq Code** [[pdf]](http://arxiv.org/abs/2403.12627) `2024-04-02` `Coq` (0 cite) (0 AI4Math cite) 
...
458. **Can Large Language Models Reason and Plan?** [[pdf]](http://arxiv.org/abs/2403.04121) `2024-04-01` (27 cite) (0 AI4Math cite) 
...
459. **OVM, Outcome-supervised Value Models for Planning in Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2311.09724) `NAACL 2024 Findings` (18 cite) (2 AI4Math cite) 
...
460. **Do language models plan ahead for future tokens?** [[pdf]](https://arxiv.org/abs/2404.00859v2) `2024-04-01` (10 cite) (0 AI4Math cite) 
...
461. **Exploring the Mystery of Influential Data for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2404.01067) `2024-04-01` (5 cite) (1 AI4Math cite) 
...
462. **GFLean: An Autoformalisation Framework for Lean via GF** [[pdf]](http://arxiv.org/abs/2404.01234) `2024-04-01` `Lean` (0 cite) (0 AI4Math cite) 
...
463. **NumeroLogic: Number Encoding for Enhanced LLMs' Numerical Reasoning** [[pdf]](http://arxiv.org/abs/2404.00459) `2024-03-30` (3 cite) (0 AI4Math cite) 
...
464. **Can LLMs Master Math? Investigating Large Language Models on Math Stack Exchange** [[pdf]](https://arxiv.org/abs/2404.00344v1) `2024-03-30` (1 cite) (0 AI4Math cite) 
...
465. **Large Language Models Are Unconscious of Unreasonability in Math Problems** [[pdf]](https://arxiv.org/abs/2403.19346v2) `2024-03-28` (1 cite) (0 AI4Math cite) 
...
466. **Dual Instruction Tuning with Large Language Models for Mathematical Reasoning** [[pdf]](http://arxiv.org/abs/2403.18295) `2024-03-27` (1 cite) (0 AI4Math cite) 
...
467. **Look Before You Leap: Problem Elaboration Prompting Improves Mathematical Reasoning in Large Language Models** [[pdf]](http://arxiv.org/abs/2402.15764) `2024-03-26` (0 cite) (0 AI4Math cite) 
...
468. **Graph of Thoughts: Solving Elaborate Problems with Large Language Models** [[pdf]](http://arxiv.org/abs/2308.09687) `AAAI 2024 Natural Language Processing` (335 cite) (14 AI4Math cite) 
...
469. **Beyond Chain-of-Thought, Effective Graph-of-Thought Reasoning in Language Models** [[pdf]](http://arxiv.org/abs/2305.16582) `2024-03-22` (6 cite) (0 AI4Math cite) 
...
470. **RankPrompt: Step-by-Step Comparisons Make Language Models Better Reasoners** [[pdf]](http://arxiv.org/abs/2403.12373) `2024-03-22` (3 cite) (0 AI4Math cite) 
...
471. **MathVerse: Does Your Multi-modal LLM Truly See the Diagrams in Visual Math Problems?** [[pdf]](https://arxiv.org/abs/2403.14624v2) `2024-03-21` (55 cite) (0 AI4Math cite) 
...
472. **Reinforcement Learning from Reflective Feedback (RLRF): Aligning and Improving LLMs via Fine-Grained Self-Reflection** [[pdf]](https://arxiv.org/abs/2403.14238v1) `2024-03-21` (3 cite) (0 AI4Math cite) 
...
473. **From Large to Tiny: Distilling and Refining Mathematical Expertise for Math Word Problems with Weakly Supervision** [[pdf]](http://arxiv.org/abs/2403.14390) `2024-03-21` (1 cite) (0 AI4Math cite) 
...
474. **A Semantic Search Engine for Mathlib4** [[pdf]](http://arxiv.org/abs/2403.13310) `2024-03-20` (0 cite) (0 AI4Math cite) 
...
475. **Arithmetic Feature Interaction Is Necessary for Deep Tabular Learning** [[pdf]](http://arxiv.org/abs/2402.02334) `AAAI 2024 Machine Learning` (0 cite) (0 AI4Math cite) 
...
476. **Quiet-STaR: Language Models Can Teach Themselves to Think Before Speaking** [[pdf]](http://arxiv.org/abs/2403.09629) `COLM 2024` (25 cite) (0 AI4Math cite) 
...
477. **Self-Consistency Boosts Calibration for Math Reasoning** [[pdf]](http://arxiv.org/abs/2403.09849) `2024-03-14` (1 cite) (0 AI4Math cite) 
...
478. **Incorporating Graph Attention Mechanism into Geometric Problem Solving Based on Deep Reinforcement Learning** [[pdf]](https://arxiv.org/abs/2403.14690v1) `2024-03-14` (0 cite) (0 AI4Math cite) 
...
479. **Laying the Foundation First? Investigating the Generalization from Atomic Skills to Complex Reasoning Tasks** [[pdf]](https://arxiv.org/abs/2403.09479v1) `2024-03-14` (0 cite) (0 AI4Math cite) 
...
480. **APOLLO: An Optimized Training Approach for Long-form Numerical Reasoning** [[pdf]](http://arxiv.org/abs/2212.07249) `2024-03-12` (5 cite) (1 AI4Math cite) 
...
481. **FineMath: A Fine-Grained Mathematical Evaluation Benchmark for Chinese Large Language Models** [[pdf]](http://arxiv.org/abs/2403.07747) `2024-03-12` (1 cite) (0 AI4Math cite) 
...
483. **RAT: Retrieval Augmented Thoughts Elicit Context-Aware Reasoning in Long-Horizon Generation** [[pdf]](http://arxiv.org/abs/2403.05313) `2024-03-08` (20 cite) (0 AI4Math cite) 
...
484. **Common 7B Language Models Already Possess Strong Math Capabilities** [[pdf]](http://arxiv.org/abs/2403.04706) `ICLR 2025 Submission` (33 cite) (3 AI4Math cite) 
...
485. **Machine learning and information theory concepts towards an AI Mathematician** [[pdf]](http://arxiv.org/abs/2403.04571) `2024-03-07` (6 cite) (1 AI4Math cite) 
...
486. **Benchmarking Hallucination in Large Language Models based on Unanswerable Math Word Problem** [[pdf]](http://arxiv.org/abs/2403.03558) `2024-03-06` (5 cite) (0 AI4Math cite) 
...
487. **Exploring the Limitations of Large Language Models in Compositional Relation Reasoning** [[pdf]](http://arxiv.org/abs/2403.02615) `2024-03-04` (4 cite) (0 AI4Math cite) 
...
488. **Functional Benchmarks for Robust Evaluation of Reasoning Performance, and the Reasoning Gap** [[pdf]](http://arxiv.org/abs/2402.19450) `2024-02-29` (22 cite) (1 AI4Math cite) 
...
489. **Automatic Prompt Augmentation and Selection with Chain-of-Thought from Labeled Data** [[pdf]](http://arxiv.org/abs/2302.12822) `EMNLP 2023 Findings` (99 cite) (4 AI4Math cite) 
...
490. **Stepwise Self-Consistent Mathematical Reasoning with Large Language Models** [[pdf]](http://arxiv.org/abs/2402.17786) `ICML 2024 Workshop ICL` (0 cite) (0 AI4Math cite) 
...
491. **ConceptMath: A Bilingual Concept-wise Benchmark for Measuring Mathematical Reasoning of Large Language Models** [[pdf]](http://arxiv.org/abs/2402.14660) `ACL 2024 Findings` (3 cite) (0 AI4Math cite) 
...
492. **Mathematical Language Models: A Survey** [[pdf]](http://arxiv.org/abs/2312.07622) `2024-02-23` (3 cite) (0 AI4Math cite) 
...
493. **An Empirical Study of Data Ability Boundary in LLMs' Math Reasoning** [[pdf]](http://arxiv.org/abs/2403.00799) `2024-02-23` (0 cite) (1 AI4Math cite) 
...
494. **Brain-Inspired Two-Stage Approach: Enhancing Mathematical Reasoning by Imitating Human Thought Processes** [[pdf]](http://arxiv.org/abs/2403.00800) `2024-02-23` (0 cite) (0 AI4Math cite) 
...
495. **Diversity of Thought Improves Reasoning Abilities of LLMs** [[pdf]](http://arxiv.org/abs/2310.07088) `2024-02-23` (0 cite) (0 AI4Math cite) 
...
496. **RevOrder: A Novel Method for Enhanced Arithmetic in Language Models** [[pdf]](http://arxiv.org/abs/2402.03822) `2024-02-23` (0 cite) (0 AI4Math cite) 
...
497. **Tokenization counts: the impact of tokenization on arithmetic in frontier LLMs** [[pdf]](http://arxiv.org/abs/2402.14903) `2024-02-22` (24 cite) (0 AI4Math cite) 
...
498. **SciAgent: Tool-augmented Language Models for Scientific Reasoning** [[pdf]](http://arxiv.org/abs/2402.11451) `2024-02-20` (8 cite) (0 AI4Math cite) 
...
499. **SymBa: Symbolic Backward Chaining for Structured Natural Language Reasoning** [[pdf]](https://arxiv.org/abs/2402.12806v2) `2024-02-20` (1 cite) (0 AI4Math cite) 
...
500. **Can LLMs Compute with Reasons?** [[pdf]](http://arxiv.org/abs/2402.12080) `2024-02-19` (0 cite) (0 AI4Math cite) 
...
501. **Learning From Failure: Integrating Negative Examples when Fine-tuning Large Language Models as Agents** [[pdf]](https://arxiv.org/abs/2402.11651v2) `2024-02-18` (6 cite) (0 AI4Math cite) 
...
502. **Orca-Math: Unlocking the potential of SLMs in Grade School Math** [[pdf]](http://arxiv.org/abs/2402.14830) `2024-02-16` (31 cite) (3 AI4Math cite) 
...
503. **AutoTutor meets Large Language Models: A Language Model Tutor with Rich Pedagogy and Guardrails** [[pdf]](https://arxiv.org/abs/2402.09216v3) `2024-02-14` (2 cite) (0 AI4Math cite) 
...
504. **FGeo-DRL: Deductive Reasoning for Geometric Problems through Deep Reinforcement Learning** [[pdf]](http://arxiv.org/abs/2402.09051) `2024-02-14` (2 cite) (0 AI4Math cite) 
...
505. **Beyond Lines and Circles: Unveiling the Geometric Reasoning Gap in Large Language Models** [[pdf]](http://arxiv.org/abs/2402.03877) `2024-02-14` (1 cite) (0 AI4Math cite) 
...
506. **FGeo-TP: A Language Model-Enhanced Solver for Geometry Problems** [[pdf]](http://arxiv.org/abs/2402.09047) `2024-02-14` (1 cite) (0 AI4Math cite) 
...
507. **FormalGeo: An Extensible Formalized Framework for Olympiad Geometric Problem Solving** [[pdf]](http://arxiv.org/abs/2310.18021) `2024-02-14` (1 cite) (0 AI4Math cite) 
...
508. **InternLM-Math: Open Math Large Language Models Toward Verifiable Reasoning** [[pdf]](http://arxiv.org/abs/2402.06332) `2024-02-09` `Lean` (33 cite) (2 AI4Math cite) 
...
509. **DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models** [[pdf]](http://arxiv.org/abs/2402.03300) `2024-02-06` `Isabelle` (123 cite) (8 AI4Math cite) 
...
510. **Large Language Models as an Indirect Reasoner: Contrapositive and Contradiction for Automated Reasoning** [[pdf]](http://arxiv.org/abs/2402.03667) `2024-02-05` (1 cite) (0 AI4Math cite) 
...
511. **REFINER: Reasoning Feedback on Intermediate Representations** [[pdf]](http://arxiv.org/abs/2304.01904) `2024-02-04` (108 cite) (17 AI4Math cite) 
...
512. **Multi-step Problem Solving Through a Verifier: An Empirical Analysis on Model-induced Process Supervision** [[pdf]](http://arxiv.org/abs/2402.02658) `2024-02-04` (5 cite) (0 AI4Math cite) 
